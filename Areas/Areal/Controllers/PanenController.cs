...
{
    public class PanenController : Controller
    {
        // GET: Areal/Panen
        [Authorize]
        ...
        public ActionResult getKebun([DataSourceRequest]DataSourceRequest request, string Id = "", string budidaya="", string tahun="", string bulan="", string cariText="")
        {
            ...
            var model = from m in CRUDGajiAbsensi.CRUD.GetRecordPerKebun().Where(o => o.KodeRekening.Trim().Length == 9)
                        ...
                        //(budidaya == "" ? true : m.NamaBudidaya == budidaya) &&
                            (m.KodeBudidaya != "00" && m.KodeBudidaya !="01" && m.KodeBudidaya != "02") &&
                        ...
                        select new DataKegiatanKebun
                        {
                            ...
                            RealisasiHasilKerja = g.Where(o => o.Bulan == int.Parse(bulan) && o.KodeRekening.Substring(0,5) == "60203").Sum(o => o.RealisasiHasilKerja),
                            ...
                            RealisasiSBIHasilKerja = g.Where(o => o.Bulan <= int.Parse(bulan) && o.KodeRekening.Substring(0,5) == "60203").Sum(o => o.RealisasiHasilKerja),
