...
{
    public class ProduktivitasKaretPerTahunController : Controller
    {
        ...
        public ActionResult ChartProtasPerKebun(string Id = "", string budidaya = "", string tahun = "", string bulan = "", string perbandingan = "", string pctBalai = "100")
        {
            ...
            var model = (from m in CRUDHasilPanen.CRUD.GetHasilPanenPerKebunPer6Bulan().Where(o => o.KodeBudidaya == "00")
                         ...
                         select new ProduktivitasPerKebun
                         {
                             ...
                             Januari_Real = (double)g.Where(o => o.Bulan == 1).Sum(o => o.KgLateks+o.KgLump) / (double)CRUDRef_Areal.CRUD.HitungLuasArealKebun(g.Key.KodeBlok, "00", "TM"),
                             Februari_Real = (double)g.Where(o => o.Bulan == 2).Sum(o => o.KgLateks+o.KgLump) / (double)CRUDRef_Areal.CRUD.HitungLuasArealKebun(g.Key.KodeBlok, "00", "TM"),
                             Maret_Real = (double)g.Where(o => o.Bulan == 3).Sum(o => o.KgLateks+o.KgLump) / (double)CRUDRef_Areal.CRUD.HitungLuasArealKebun(g.Key.KodeBlok, "00", "TM"),
                             April_Real = (double)g.Where(o => o.Bulan == 4).Sum(o => o.KgLateks+o.KgLump) / (double)CRUDRef_Areal.CRUD.HitungLuasArealKebun(g.Key.KodeBlok, "00", "TM"),
                             Mei_Real = (double)g.Where(o => o.Bulan == 5).Sum(o => o.KgLateks+o.KgLump) / (double)CRUDRef_Areal.CRUD.HitungLuasArealKebun(g.Key.KodeBlok, "00", "TM"),
                             Juni_Real = (double)g.Where(o => o.Bulan == 6).Sum(o => o.KgLateks+o.KgLump) / (double)CRUDRef_Areal.CRUD.HitungLuasArealKebun(g.Key.KodeBlok, "00", "TM"),
                             Juli_Real = (double)g.Where(o => o.Bulan == 7).Sum(o => o.KgLateks+o.KgLump) / (double)CRUDRef_Areal.CRUD.HitungLuasArealKebun(g.Key.KodeBlok, "00", "TM"),
                             Agustus_Real = (double)g.Where(o => o.Bulan == 8).Sum(o => o.KgLateks+o.KgLump) / (double)CRUDRef_Areal.CRUD.HitungLuasArealKebun(g.Key.KodeBlok, "00", "TM"),
                             September_Real = (double)g.Where(o => o.Bulan == 9).Sum(o => o.KgLateks+o.KgLump) / (double)CRUDRef_Areal.CRUD.HitungLuasArealKebun(g.Key.KodeBlok, "00", "TM"),
                             Oktober_Real = (double)g.Where(o => o.Bulan == 10).Sum(o => o.KgLateks+o.KgLump) / (double)CRUDRef_Areal.CRUD.HitungLuasArealKebun(g.Key.KodeBlok, "00", "TM"),
                             November_Real = (double)g.Where(o => o.Bulan == 11).Sum(o => o.KgLateks+o.KgLump) / (double)CRUDRef_Areal.CRUD.HitungLuasArealKebun(g.Key.KodeBlok, "00", "TM"),
                             Desember_Real = (double)g.Where(o => o.Bulan == 12).Sum(o => o.KgLateks+o.KgLump) / (double)CRUDRef_Areal.CRUD.HitungLuasArealKebun(g.Key.KodeBlok, "00", "TM"),

                             Januari_PTPN8 = (double)(CRUDHasilPanen.CRUD.GetHasilPanenPerKebun().Where(o => o.KodeBudidaya == "00" && o.Bulan == 1).Sum(o => o.KgLateks+o.KgLump)) / (double)CRUDRef_Areal.CRUD.HitungLuasArealPTPN8("00", "TM"),
                             Februari_PTPN8 = (double)(CRUDHasilPanen.CRUD.GetHasilPanenPerKebun().Where(o => o.KodeBudidaya == "00" && o.Bulan == 2).Sum(o => o.KgLateks+o.KgLump)) / (double)CRUDRef_Areal.CRUD.HitungLuasArealPTPN8("00", "TM"),
                             Maret_PTPN8 = (double)(CRUDHasilPanen.CRUD.GetHasilPanenPerKebun().Where(o => o.KodeBudidaya == "00" && o.Bulan == 3).Sum(o => o.KgLateks+o.KgLump)) / (double)CRUDRef_Areal.CRUD.HitungLuasArealPTPN8("00", "TM"),
                             April_PTPN8 = (double)(CRUDHasilPanen.CRUD.GetHasilPanenPerKebun().Where(o => o.KodeBudidaya == "00" && o.Bulan == 4).Sum(o => o.KgLateks+o.KgLump)) / (double)CRUDRef_Areal.CRUD.HitungLuasArealPTPN8("00", "TM"),
                             Mei_PTPN8 = (double)(CRUDHasilPanen.CRUD.GetHasilPanenPerKebun().Where(o => o.KodeBudidaya == "00" && o.Bulan == 5).Sum(o => o.KgLateks+o.KgLump)) / (double)CRUDRef_Areal.CRUD.HitungLuasArealPTPN8("00", "TM"),
                             Juni_PTPN8 = (double)(CRUDHasilPanen.CRUD.GetHasilPanenPerKebun().Where(o => o.KodeBudidaya == "00" && o.Bulan == 6).Sum(o => o.KgLateks+o.KgLump)) / (double)CRUDRef_Areal.CRUD.HitungLuasArealPTPN8("00", "TM"),
                             Juli_PTPN8 = (double)(CRUDHasilPanen.CRUD.GetHasilPanenPerKebun().Where(o => o.KodeBudidaya == "00" && o.Bulan == 7).Sum(o => o.KgLateks+o.KgLump)) / (double)CRUDRef_Areal.CRUD.HitungLuasArealPTPN8("00", "TM"),
                             Agustus_PTPN8 = (double)(CRUDHasilPanen.CRUD.GetHasilPanenPerKebun().Where(o => o.KodeBudidaya == "00" && o.Bulan == 8).Sum(o => o.KgLateks+o.KgLump)) / (double)CRUDRef_Areal.CRUD.HitungLuasArealPTPN8("00", "TM"),
                             September_PTPN8 = (double)(CRUDHasilPanen.CRUD.GetHasilPanenPerKebun().Where(o => o.KodeBudidaya == "00" && o.Bulan == 9).Sum(o => o.KgLateks+o.KgLump)) / (double)CRUDRef_Areal.CRUD.HitungLuasArealPTPN8("00", "TM"),
                             Oktober_PTPN8 = (double)(CRUDHasilPanen.CRUD.GetHasilPanenPerKebun().Where(o => o.KodeBudidaya == "00" && o.Bulan == 10).Sum(o => o.KgLateks+o.KgLump)) / (double)CRUDRef_Areal.CRUD.HitungLuasArealPTPN8("00", "TM"),
                             November_PTPN8 = (double)(CRUDHasilPanen.CRUD.GetHasilPanenPerKebun().Where(o => o.KodeBudidaya == "00" && o.Bulan == 11).Sum(o => o.KgLateks+o.KgLump)) / (double)CRUDRef_Areal.CRUD.HitungLuasArealPTPN8("00", "TM"),
                             Desember_PTPN8 = (double)(CRUDHasilPanen.CRUD.GetHasilPanenPerKebun().Where(o => o.KodeBudidaya == "00" && o.Bulan == 12).Sum(o => o.KgLateks+o.KgLump)) / (double)CRUDRef_Areal.CRUD.HitungLuasArealPTPN8("00", "TM")
                         }).ToList();
        ...
        public ActionResult ProtasPerKebun([DataSourceRequest]DataSourceRequest request, string Id = "", string budidaya = "", string tahun = "", string bulan = "")
        {
            ...
            var model1 = (from m in CRUDHasilPanen.CRUD.GetHasilPanenPerKebunPer6Bulan().Where(o => o.KodeBudidaya == "00")
                         ...
                         select new ProduktivitasPerKebun
                         {
                             ...
                             LuasArealInduk = CRUDRef_Areal.CRUD.HitungLuasArealPTPN8("00", "TM", g.Key.g2),
                             Januari_Real = (double) g.Where(o => o.Bulan == 1).Sum(o => o.KgLateks+o.KgLump), 
                             Februari_Real = (double)g.Where(o => o.Bulan == 2).Sum(o => o.KgLateks+o.KgLump), 
                             Maret_Real = (double)g.Where(o => o.Bulan == 3).Sum(o => o.KgLateks+o.KgLump),
                             April_Real = (double)g.Where(o => o.Bulan == 4).Sum(o => o.KgLateks+o.KgLump),
                             Mei_Real = (double)g.Where(o => o.Bulan == 5).Sum(o => o.KgLateks+o.KgLump),
                             Juni_Real = (double)g.Where(o => o.Bulan == 6).Sum(o => o.KgLateks+o.KgLump),
                             Juli_Real = (double)g.Where(o => o.Bulan == 7).Sum(o => o.KgLateks+o.KgLump),
                             Agustus_Real = (double)g.Where(o => o.Bulan == 8).Sum(o => o.KgLateks+o.KgLump),
                             September_Real = (double)g.Where(o => o.Bulan == 9).Sum(o => o.KgLateks+o.KgLump),
                             Oktober_Real = (double)g.Where(o => o.Bulan == 10).Sum(o => o.KgLateks+o.KgLump),
                             November_Real = (double)g.Where(o => o.Bulan == 11).Sum(o => o.KgLateks+o.KgLump),
                             Desember_Real = (double)g.Where(o => o.Bulan == 12).Sum(o => o.KgLateks+o.KgLump),
                         }).ToList();
        ...
        public ActionResult KebunGeoJSon(string Id = "", string budidaya = "", string tahun = "", string bulan = "", string warna = "", string perbandingan = "", string pctBalai = "100")
        {
            ...
            var model1 = (from m in CRUDHasilPanen.CRUD.GetHasilPanenPerKebunPer6Bulan().Where(o => o.KodeBudidaya == "00")
                          where (userStatus.NamaLokasiKerja == "Afdeling" ? m.KodeBlok.Substring(0, 2) == CRUDKebun.CRUD.Get1Record(userStatus.PosisiLokasiKerjaId).kd_kbn : userStatus.NamaLokasiKerja == "Kebun" || userStatus.NamaLokasiKerja == "Bidang" ? CRUDKebun.CRUD.Get1Record(m.KodeBlok.Substring(0, 2)).WilayahId == CRUDKebun.CRUD.Get1Record(userStatus.PosisiLokasiKerjaId).WilayahId : true)
                          ...
                          select new ProduktivitasPerKebun
                          {
                              ...
                              Budidaya = "Karet",
                              TahunTanam = string.Join(",", g.Select(o => o.TahunTanam).ToArray()),
                              LuasAreal = CRUDRef_Areal.CRUD.HitungLuasArealKebun(g.Key.g1, "00", "TM"),
                              LuasArealInduk = CRUDRef_Areal.CRUD.HitungLuasArealPTPN8("00", "TM"),
                              Januari_Real = (double)g.Where(o => o.Bulan == 1).Sum(o => o.KgLateks+o.KgLump),
                              Februari_Real = (double)g.Where(o => o.Bulan == 2).Sum(o => o.KgLateks+o.KgLump),
                              Maret_Real = (double)g.Where(o => o.Bulan == 3).Sum(o => o.KgLateks+o.KgLump),
                              April_Real = (double)g.Where(o => o.Bulan == 4).Sum(o => o.KgLateks+o.KgLump),
        ...
        public ActionResult ChartProtasPerAfdeling(string Id = "", string budidaya = "", string tahun = "", string bulan = "", string perbandingan = "", string pctBalai = "100")
        {
            ...
            var model = (from m in CRUDHasilPanen.CRUD.GetHasilPanenPerAfdelingPer6Bulan().Where(o => o.KodeBudidaya == "00" && o.KodeBlok.Substring(0,2)==Id)
                         group m by new { m.KodeBlok } into g
                         select new ProduktivitasPerAfdeling
                         {
                             ...
                             Januari_Real = (double)g.Where(o => o.Bulan == 1).Sum(o => o.KgLateks+o.KgLump) / (double)CRUDRef_Areal.CRUD.HitungLuasArealAfdeling(g.Key.KodeBlok, "00", "TM"),
                             Februari_Real = (double)g.Where(o => o.Bulan == 2).Sum(o => o.KgLateks+o.KgLump) / (double)CRUDRef_Areal.CRUD.HitungLuasArealAfdeling(g.Key.KodeBlok, "00", "TM"),
                             Maret_Real = (double)g.Where(o => o.Bulan == 3).Sum(o => o.KgLateks+o.KgLump) / (double)CRUDRef_Areal.CRUD.HitungLuasArealAfdeling(g.Key.KodeBlok, "00", "TM"),
                             April_Real = (double)g.Where(o => o.Bulan == 4).Sum(o => o.KgLateks+o.KgLump) / (double)CRUDRef_Areal.CRUD.HitungLuasArealAfdeling(g.Key.KodeBlok, "00", "TM"),
                             Mei_Real = (double)g.Where(o => o.Bulan == 5).Sum(o => o.KgLateks+o.KgLump) / (double)CRUDRef_Areal.CRUD.HitungLuasArealAfdeling(g.Key.KodeBlok, "00", "TM"),
                             Juni_Real = (double)g.Where(o => o.Bulan == 6).Sum(o => o.KgLateks+o.KgLump) / (double)CRUDRef_Areal.CRUD.HitungLuasArealAfdeling(g.Key.KodeBlok, "00", "TM"),
                             Juli_Real = (double)g.Where(o => o.Bulan == 7).Sum(o => o.KgLateks+o.KgLump) / (double)CRUDRef_Areal.CRUD.HitungLuasArealAfdeling(g.Key.KodeBlok, "00", "TM"),
                             Agustus_Real = (double)g.Where(o => o.Bulan == 8).Sum(o => o.KgLateks+o.KgLump) / (double)CRUDRef_Areal.CRUD.HitungLuasArealAfdeling(g.Key.KodeBlok, "00", "TM"),
                             September_Real = (double)g.Where(o => o.Bulan == 9).Sum(o => o.KgLateks+o.KgLump) / (double)CRUDRef_Areal.CRUD.HitungLuasArealAfdeling(g.Key.KodeBlok, "00", "TM"),
                             Oktober_Real = (double)g.Where(o => o.Bulan == 10).Sum(o => o.KgLateks+o.KgLump) / (double)CRUDRef_Areal.CRUD.HitungLuasArealAfdeling(g.Key.KodeBlok, "00", "TM"),
                             November_Real = (double)g.Where(o => o.Bulan == 11).Sum(o => o.KgLateks+o.KgLump) / (double)CRUDRef_Areal.CRUD.HitungLuasArealAfdeling(g.Key.KodeBlok, "00", "TM"),
                             Desember_Real = (double)g.Where(o => o.Bulan == 12).Sum(o => o.KgLateks+o.KgLump) / (double)CRUDRef_Areal.CRUD.HitungLuasArealAfdeling(g.Key.KodeBlok, "00", "TM"),

                             Januari_PTPN8 = (double)(CRUDHasilPanen.CRUD.GetHasilPanenPerKebun().Where(o => o.KodeBudidaya == "00" && o.Bulan == 1 && o.KodeBlok == g.Key.KodeBlok.Substring(0,2) ).Sum(o => o.KgLateks+o.KgLump)) / (double)CRUDRef_Areal.CRUD.HitungLuasArealKebun(g.Key.KodeBlok.Substring(0,2),"00", "TM"),
                             Februari_PTPN8 = (double)(CRUDHasilPanen.CRUD.GetHasilPanenPerKebun().Where(o => o.KodeBudidaya == "00" && o.Bulan == 2 && o.KodeBlok == g.Key.KodeBlok.Substring(0, 2)).Sum(o => o.KgLateks+o.KgLump)) / (double)CRUDRef_Areal.CRUD.HitungLuasArealKebun(g.Key.KodeBlok.Substring(0, 2), "00", "TM"),
                             Maret_PTPN8 = (double)(CRUDHasilPanen.CRUD.GetHasilPanenPerKebun().Where(o => o.KodeBudidaya == "00" && o.Bulan == 3 && o.KodeBlok == g.Key.KodeBlok.Substring(0, 2)).Sum(o => o.KgLateks+o.KgLump)) / (double)CRUDRef_Areal.CRUD.HitungLuasArealKebun(g.Key.KodeBlok.Substring(0, 2), "00", "TM"),
                             April_PTPN8 = (double)(CRUDHasilPanen.CRUD.GetHasilPanenPerKebun().Where(o => o.KodeBudidaya == "00" && o.Bulan == 4 && o.KodeBlok == g.Key.KodeBlok.Substring(0, 2)).Sum(o => o.KgLateks+o.KgLump)) / (double)CRUDRef_Areal.CRUD.HitungLuasArealKebun(g.Key.KodeBlok.Substring(0, 2), "00", "TM"),
                             Mei_PTPN8 = (double)(CRUDHasilPanen.CRUD.GetHasilPanenPerKebun().Where(o => o.KodeBudidaya == "00" && o.Bulan == 5 && o.KodeBlok == g.Key.KodeBlok.Substring(0, 2)).Sum(o => o.KgLateks+o.KgLump)) / (double)CRUDRef_Areal.CRUD.HitungLuasArealKebun(g.Key.KodeBlok.Substring(0, 2), "00", "TM"),
                             Juni_PTPN8 = (double)(CRUDHasilPanen.CRUD.GetHasilPanenPerKebun().Where(o => o.KodeBudidaya == "00" && o.Bulan == 6 && o.KodeBlok == g.Key.KodeBlok.Substring(0, 2)).Sum(o => o.KgLateks+o.KgLump)) / (double)CRUDRef_Areal.CRUD.HitungLuasArealKebun(g.Key.KodeBlok.Substring(0, 2), "00", "TM"),
                             Juli_PTPN8 = (double)(CRUDHasilPanen.CRUD.GetHasilPanenPerKebun().Where(o => o.KodeBudidaya == "00" && o.Bulan == 7 && o.KodeBlok == g.Key.KodeBlok.Substring(0, 2)).Sum(o => o.KgLateks+o.KgLump)) / (double)CRUDRef_Areal.CRUD.HitungLuasArealKebun(g.Key.KodeBlok.Substring(0, 2), "00", "TM"),
                             Agustus_PTPN8 = (double)(CRUDHasilPanen.CRUD.GetHasilPanenPerKebun().Where(o => o.KodeBudidaya == "00" && o.Bulan == 8 && o.KodeBlok == g.Key.KodeBlok.Substring(0, 2)).Sum(o => o.KgLateks+o.KgLump)) / (double)CRUDRef_Areal.CRUD.HitungLuasArealKebun(g.Key.KodeBlok.Substring(0, 2), "00", "TM"),
                             September_PTPN8 = (double)(CRUDHasilPanen.CRUD.GetHasilPanenPerKebun().Where(o => o.KodeBudidaya == "00" && o.Bulan == 9 && o.KodeBlok == g.Key.KodeBlok.Substring(0, 2)).Sum(o => o.KgLateks+o.KgLump)) / (double)CRUDRef_Areal.CRUD.HitungLuasArealKebun(g.Key.KodeBlok.Substring(0, 2), "00", "TM"),
                             Oktober_PTPN8 = (double)(CRUDHasilPanen.CRUD.GetHasilPanenPerKebun().Where(o => o.KodeBudidaya == "00" && o.Bulan == 10 && o.KodeBlok == g.Key.KodeBlok.Substring(0, 2)).Sum(o => o.KgLateks+o.KgLump)) / (double)CRUDRef_Areal.CRUD.HitungLuasArealKebun(g.Key.KodeBlok.Substring(0, 2), "00", "TM"),
                             November_PTPN8 = (double)(CRUDHasilPanen.CRUD.GetHasilPanenPerKebun().Where(o => o.KodeBudidaya == "00" && o.Bulan == 11 && o.KodeBlok == g.Key.KodeBlok.Substring(0, 2)).Sum(o => o.KgLateks+o.KgLump)) / (double)CRUDRef_Areal.CRUD.HitungLuasArealKebun(g.Key.KodeBlok.Substring(0, 2), "00", "TM"),
                             Desember_PTPN8 = (double)(CRUDHasilPanen.CRUD.GetHasilPanenPerKebun().Where(o => o.KodeBudidaya == "00" && o.Bulan == 12 && o.KodeBlok == g.Key.KodeBlok.Substring(0, 2)).Sum(o => o.KgLateks+o.KgLump)) / (double)CRUDRef_Areal.CRUD.HitungLuasArealKebun(g.Key.KodeBlok.Substring(0, 2), "00", "TM")
                         }).ToList();
        ...
        public ActionResult ProtasPerAfdeling([DataSourceRequest]DataSourceRequest request, string Id = "", string budidaya = "", string tahun = "", string bulan = "", string perbandingan = "", string pctBalai = "100")
        {
            ...
            var model1 = (from m in CRUDHasilPanen.CRUD.GetHasilPanenPerAfdelingPer6Bulan().Where(o => o.KodeBudidaya == "00" && o.KodeBlok.Substring(0,2)==Id)
                          group m by new { g1 = m.KodeBlok, g2 = m.TahunTanam } into g
                          select new ProduktivitasPerAfdeling
                          {
                              ...
                              LuasArealInduk = CRUDRef_Areal.CRUD.HitungLuasArealKebun(g.Key.g1.Substring(0,2),"00","TM", g.Key.g2),
                              Januari_Real = (double)g.Where(o => o.Bulan == 1).Sum(o => o.KgLateks+o.KgLump),
                              Februari_Real = (double)g.Where(o => o.Bulan == 2).Sum(o => o.KgLateks+o.KgLump),
                              Maret_Real = (double)g.Where(o => o.Bulan == 3).Sum(o => o.KgLateks+o.KgLump),
                              April_Real = (double)g.Where(o => o.Bulan == 4).Sum(o => o.KgLateks+o.KgLump),
        ...
        public ActionResult AfdelingGeoJSon(string Id = "", string budidaya = "", string tahun = "", string bulan = "", string warna = "", string perbandingan = "", string pctBalai = "100")
        {
            ...
            var model1 = (from m in CRUDHasilPanen.CRUD.GetHasilPanenPerAfdelingPer6Bulan().Where(o => o.KodeBudidaya == "00" && o.KodeBlok.Substring(0,2)==Id)
                          ...
                          select new ProduktivitasPerAfdeling
                          {
                              ...
                              Budidaya = "Karet",
                              TahunTanam = string.Join(",", g.Select(o => o.TahunTanam).ToArray()),
                              LuasAreal = CRUDRef_Areal.CRUD.HitungLuasArealAfdeling(g.Key.g1, "00", "TM"),
                              LuasArealInduk = CRUDRef_Areal.CRUD.HitungLuasArealKebun(g.Key.g1.Substring(0,2),"00", "TM"),
                              Januari_Real = (double)g.Where(o => o.Bulan == 1).Sum(o => o.KgLateks+o.KgLump),
                              Februari_Real = (double)g.Where(o => o.Bulan == 2).Sum(o => o.KgLateks+o.KgLump),
                              Maret_Real = (double)g.Where(o => o.Bulan == 3).Sum(o => o.KgLateks+o.KgLump),
                              April_Real = (double)g.Where(o => o.Bulan == 4).Sum(o => o.KgLateks+o.KgLump),
        ...
        public ActionResult ChartProtasPerBlok(string Id = "", string budidaya = "", string tahun = "", string bulan = "", string perbandingan = "", string pctBalai = "100")
        {
            ...
            var model = (from m in CRUDHasilPanen.CRUD.GetHasilPanenPerBlokPer6Bulan().Where(o => o.KodeBudidaya == "00" && o.KodeBlok.Substring(0, 4) == Id)
                         group m by new { m.KodeBlok } into g
                         select new ProduktivitasPerBlok
                         {
                             ...
                             Blok = CRUDRef_Areal.CRUD.Get1Record(g.Key.KodeBlok, "00", "TM") == null ? "" : CRUDRef_Areal.CRUD.Get1Record(g.Key.KodeBlok, "00", "TM").namablok,
                             ...
                             Januari_Real = (double)g.Where(o => o.Bulan == 1).Sum(o => o.KgLateks+o.KgLump) / (double)CRUDRef_Areal.CRUD.HitungLuasArealBlok(g.Key.KodeBlok, "00", "TM"),
                             Februari_Real = (double)g.Where(o => o.Bulan == 2).Sum(o => o.KgLateks+o.KgLump) / (double)CRUDRef_Areal.CRUD.HitungLuasArealBlok(g.Key.KodeBlok, "00", "TM"),
                             Maret_Real = (double)g.Where(o => o.Bulan == 3).Sum(o => o.KgLateks+o.KgLump) / (double)CRUDRef_Areal.CRUD.HitungLuasArealBlok(g.Key.KodeBlok, "00", "TM"),
                             April_Real = (double)g.Where(o => o.Bulan == 4).Sum(o => o.KgLateks+o.KgLump) / (double)CRUDRef_Areal.CRUD.HitungLuasArealBlok(g.Key.KodeBlok, "00", "TM"),
                             Mei_Real = (double)g.Where(o => o.Bulan == 5).Sum(o => o.KgLateks+o.KgLump) / (double)CRUDRef_Areal.CRUD.HitungLuasArealBlok(g.Key.KodeBlok, "00", "TM"),
                             Juni_Real = (double)g.Where(o => o.Bulan == 6).Sum(o => o.KgLateks+o.KgLump) / (double)CRUDRef_Areal.CRUD.HitungLuasArealBlok(g.Key.KodeBlok, "00", "TM"),
                             Juli_Real = (double)g.Where(o => o.Bulan == 7).Sum(o => o.KgLateks+o.KgLump) / (double)CRUDRef_Areal.CRUD.HitungLuasArealBlok(g.Key.KodeBlok, "00", "TM"),
                             Agustus_Real = (double)g.Where(o => o.Bulan == 8).Sum(o => o.KgLateks+o.KgLump) / (double)CRUDRef_Areal.CRUD.HitungLuasArealBlok(g.Key.KodeBlok, "00", "TM"),
                             September_Real = (double)g.Where(o => o.Bulan == 9).Sum(o => o.KgLateks+o.KgLump) / (double)CRUDRef_Areal.CRUD.HitungLuasArealBlok(g.Key.KodeBlok, "00", "TM"),
                             Oktober_Real = (double)g.Where(o => o.Bulan == 10).Sum(o => o.KgLateks+o.KgLump) / (double)CRUDRef_Areal.CRUD.HitungLuasArealBlok(g.Key.KodeBlok, "00", "TM"),
                             November_Real = (double)g.Where(o => o.Bulan == 11).Sum(o => o.KgLateks+o.KgLump) / (double)CRUDRef_Areal.CRUD.HitungLuasArealBlok(g.Key.KodeBlok, "00", "TM"),
                             Desember_Real = (double)g.Where(o => o.Bulan == 12).Sum(o => o.KgLateks+o.KgLump) / (double)CRUDRef_Areal.CRUD.HitungLuasArealBlok(g.Key.KodeBlok, "00", "TM"),

                             Januari_PTPN8 = (double)(CRUDHasilPanen.CRUD.GetHasilPanenPerAfdeling().Where(o => o.KodeBudidaya == "00" && o.Bulan == 1 && o.KodeBlok == g.Key.KodeBlok.Substring(0, 4)).Sum(o => o.KgLateks+o.KgLump)) / (double)CRUDRef_Areal.CRUD.HitungLuasArealAfdeling(g.Key.KodeBlok.Substring(0, 4), "00", "TM"),
                             Februari_PTPN8 = (double)(CRUDHasilPanen.CRUD.GetHasilPanenPerAfdeling().Where(o => o.KodeBudidaya == "00" && o.Bulan == 2 && o.KodeBlok == g.Key.KodeBlok.Substring(0, 4)).Sum(o => o.KgLateks+o.KgLump)) / (double)CRUDRef_Areal.CRUD.HitungLuasArealAfdeling(g.Key.KodeBlok.Substring(0, 4), "00", "TM"),
                             Maret_PTPN8 = (double)(CRUDHasilPanen.CRUD.GetHasilPanenPerAfdeling().Where(o => o.KodeBudidaya == "00" && o.Bulan == 3 && o.KodeBlok == g.Key.KodeBlok.Substring(0, 4)).Sum(o => o.KgLateks+o.KgLump)) / (double)CRUDRef_Areal.CRUD.HitungLuasArealAfdeling(g.Key.KodeBlok.Substring(0, 4), "00", "TM"),
                             April_PTPN8 = (double)(CRUDHasilPanen.CRUD.GetHasilPanenPerAfdeling().Where(o => o.KodeBudidaya == "00" && o.Bulan == 4 && o.KodeBlok == g.Key.KodeBlok.Substring(0, 4)).Sum(o => o.KgLateks+o.KgLump)) / (double)CRUDRef_Areal.CRUD.HitungLuasArealAfdeling(g.Key.KodeBlok.Substring(0, 4), "00", "TM"),
                             Mei_PTPN8 = (double)(CRUDHasilPanen.CRUD.GetHasilPanenPerAfdeling().Where(o => o.KodeBudidaya == "00" && o.Bulan == 5 && o.KodeBlok == g.Key.KodeBlok.Substring(0, 4)).Sum(o => o.KgLateks+o.KgLump)) / (double)CRUDRef_Areal.CRUD.HitungLuasArealAfdeling(g.Key.KodeBlok.Substring(0, 4), "00", "TM"),
                             Juni_PTPN8 = (double)(CRUDHasilPanen.CRUD.GetHasilPanenPerAfdeling().Where(o => o.KodeBudidaya == "00" && o.Bulan == 6 && o.KodeBlok == g.Key.KodeBlok.Substring(0, 4)).Sum(o => o.KgLateks+o.KgLump)) / (double)CRUDRef_Areal.CRUD.HitungLuasArealAfdeling(g.Key.KodeBlok.Substring(0, 4), "00", "TM"),
                             Juli_PTPN8 = (double)(CRUDHasilPanen.CRUD.GetHasilPanenPerAfdeling().Where(o => o.KodeBudidaya == "00" && o.Bulan == 7 && o.KodeBlok == g.Key.KodeBlok.Substring(0, 4)).Sum(o => o.KgLateks+o.KgLump)) / (double)CRUDRef_Areal.CRUD.HitungLuasArealAfdeling(g.Key.KodeBlok.Substring(0, 4), "00", "TM"),
                             Agustus_PTPN8 = (double)(CRUDHasilPanen.CRUD.GetHasilPanenPerAfdeling().Where(o => o.KodeBudidaya == "00" && o.Bulan == 8 && o.KodeBlok == g.Key.KodeBlok.Substring(0, 4)).Sum(o => o.KgLateks+o.KgLump)) / (double)CRUDRef_Areal.CRUD.HitungLuasArealAfdeling(g.Key.KodeBlok.Substring(0, 4), "00", "TM"),
                             September_PTPN8 = (double)(CRUDHasilPanen.CRUD.GetHasilPanenPerAfdeling().Where(o => o.KodeBudidaya == "00" && o.Bulan == 9 && o.KodeBlok == g.Key.KodeBlok.Substring(0, 4)).Sum(o => o.KgLateks+o.KgLump)) / (double)CRUDRef_Areal.CRUD.HitungLuasArealAfdeling(g.Key.KodeBlok.Substring(0, 4), "00", "TM"),
                             Oktober_PTPN8 = (double)(CRUDHasilPanen.CRUD.GetHasilPanenPerAfdeling().Where(o => o.KodeBudidaya == "00" && o.Bulan == 10 && o.KodeBlok == g.Key.KodeBlok.Substring(0, 4)).Sum(o => o.KgLateks+o.KgLump)) / (double)CRUDRef_Areal.CRUD.HitungLuasArealAfdeling(g.Key.KodeBlok.Substring(0, 4), "00", "TM"),
                             November_PTPN8 = (double)(CRUDHasilPanen.CRUD.GetHasilPanenPerAfdeling().Where(o => o.KodeBudidaya == "00" && o.Bulan == 11 && o.KodeBlok == g.Key.KodeBlok.Substring(0, 4)).Sum(o => o.KgLateks+o.KgLump)) / (double)CRUDRef_Areal.CRUD.HitungLuasArealAfdeling(g.Key.KodeBlok.Substring(0, 4), "00", "TM"),
                             Desember_PTPN8 = (double)(CRUDHasilPanen.CRUD.GetHasilPanenPerAfdeling().Where(o => o.KodeBudidaya == "00" && o.Bulan == 12 && o.KodeBlok == g.Key.KodeBlok.Substring(0, 4)).Sum(o => o.KgLateks+o.KgLump)) / (double)CRUDRef_Areal.CRUD.HitungLuasArealAfdeling(g.Key.KodeBlok.Substring(0, 4), "00", "TM"),
                         }).ToList();
        ...
        public ActionResult ProtasPerBlok([DataSourceRequest]DataSourceRequest request, string Id = "", string budidaya = "", string tahun = "", string bulan = "", string perbandingan = "", string pctBalai = "100")
        {
            ...
            var model1 = (from m in CRUDHasilPanen.CRUD.GetHasilPanenPerBlokPer6Bulan().Where(o => o.KodeBudidaya == "00" && o.KodeBlok.Substring(0, 4) == Id)
                          group m by new { g1 = m.KodeBlok, g2 = m.TahunTanam } into g
                          select new ProduktivitasPerBlok
                          {
                              Id = CRUDBlok.CRUD.Get1Record(g.Key.g1) == null ? Guid.Empty : CRUDBlok.CRUD.Get1Record(g.Key.g1).BlokId,
                              Blok = CRUDRef_Areal.CRUD.Get1Record(g.Key.g1,"00","TM") == null ? "" : CRUDRef_Areal.CRUD.Get1Record(g.Key.g1, "00", "TM").namablok,
                              ...
                              LuasArealInduk = CRUDRef_Areal.CRUD.HitungLuasArealAfdeling(g.Key.g1.Substring(0, 4),"00", "TM", g.Key.g2),
                              Januari_Real = (double)g.Where(o => o.Bulan == 1).Sum(o => o.KgLateks+o.KgLump),
                              Februari_Real = (double)g.Where(o => o.Bulan == 2).Sum(o => o.KgLateks+o.KgLump),
                              Maret_Real = (double)g.Where(o => o.Bulan == 3).Sum(o => o.KgLateks+o.KgLump),
                              April_Real = (double)g.Where(o => o.Bulan == 4).Sum(o => o.KgLateks+o.KgLump),
        ...
        public ActionResult BlokGeoJSon(string Id = "", string budidaya = "", string tahun = "", string bulan = "", string warna = "", string perbandingan = "", string pctBalai = "100")
        {
            ...
            var model1 = (from m in CRUDHasilPanen.CRUD.GetHasilPanenPerBlokPer6Bulan().Where(o => o.KodeBudidaya == "00" && o.KodeBlok.Substring(0, 4) == Id)
                          ...
                          select new ProduktivitasPerBlok
                          {
                              ...
                              Budidaya = "Karet",
                              TahunTanam = string.Join(",", g.Select(o => o.TahunTanam).ToArray()),
                              LuasAreal = CRUDRef_Areal.CRUD.HitungLuasArealBlok(g.Key.g1, "00", "TM"),
                              LuasArealInduk = CRUDRef_Areal.CRUD.HitungLuasArealAfdeling(g.Key.g1.Substring(0, 4),"00", "TM"),
                              Januari_Real = (double)g.Where(o => o.Bulan == 1).Sum(o => o.KgLateks+o.KgLump),
                              Februari_Real = (double)g.Where(o => o.Bulan == 2).Sum(o => o.KgLateks+o.KgLump),
                              Maret_Real = (double)g.Where(o => o.Bulan == 3).Sum(o => o.KgLateks+o.KgLump),
                              April_Real = (double)g.Where(o => o.Bulan == 4).Sum(o => o.KgLateks+o.KgLump),
