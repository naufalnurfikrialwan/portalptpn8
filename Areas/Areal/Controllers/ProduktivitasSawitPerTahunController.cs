...
{
    public class ProduktivitasSawitPerTahunController : Controller
    {
        ...
        public ActionResult ChartProtasPerKebun(string Id = "", string budidaya = "", string tahun = "", string bulan = "", string perbandingan = "", string pctBalai = "100")
        {
            ...
            var model = (from m in CRUDHasilPanen.CRUD.GetHasilPanenPerKebunPer6Bulan().Where(o => o.KodeBudidaya == "01")
                         ...
                         select new ProduktivitasPerKebun
                         {
                             ...
                             Januari_Real = (double)g.Where(o => o.Bulan == 1).Sum(o => o.KgTBS) / (double)CRUDRef_Areal.CRUD.HitungLuasArealKebun(g.Key.KodeBlok, "01", "TM"),
                             Februari_Real = (double)g.Where(o => o.Bulan == 2).Sum(o => o.KgTBS) / (double)CRUDRef_Areal.CRUD.HitungLuasArealKebun(g.Key.KodeBlok, "01", "TM"),
                             Maret_Real = (double)g.Where(o => o.Bulan == 3).Sum(o => o.KgTBS) / (double)CRUDRef_Areal.CRUD.HitungLuasArealKebun(g.Key.KodeBlok, "01", "TM"),
                             April_Real = (double)g.Where(o => o.Bulan == 4).Sum(o => o.KgTBS) / (double)CRUDRef_Areal.CRUD.HitungLuasArealKebun(g.Key.KodeBlok, "01", "TM"),
                             Mei_Real = (double)g.Where(o => o.Bulan == 5).Sum(o => o.KgTBS) / (double)CRUDRef_Areal.CRUD.HitungLuasArealKebun(g.Key.KodeBlok, "01", "TM"),
                             Juni_Real = (double)g.Where(o => o.Bulan == 6).Sum(o => o.KgTBS) / (double)CRUDRef_Areal.CRUD.HitungLuasArealKebun(g.Key.KodeBlok, "01", "TM"),
                             Juli_Real = (double)g.Where(o => o.Bulan == 7).Sum(o => o.KgTBS) / (double)CRUDRef_Areal.CRUD.HitungLuasArealKebun(g.Key.KodeBlok, "01", "TM"),
                             Agustus_Real = (double)g.Where(o => o.Bulan == 8).Sum(o => o.KgTBS) / (double)CRUDRef_Areal.CRUD.HitungLuasArealKebun(g.Key.KodeBlok, "01", "TM"),
                             September_Real = (double)g.Where(o => o.Bulan == 9).Sum(o => o.KgTBS) / (double)CRUDRef_Areal.CRUD.HitungLuasArealKebun(g.Key.KodeBlok, "01", "TM"),
                             Oktober_Real = (double)g.Where(o => o.Bulan == 10).Sum(o => o.KgTBS) / (double)CRUDRef_Areal.CRUD.HitungLuasArealKebun(g.Key.KodeBlok, "01", "TM"),
                             November_Real = (double)g.Where(o => o.Bulan == 11).Sum(o => o.KgTBS) / (double)CRUDRef_Areal.CRUD.HitungLuasArealKebun(g.Key.KodeBlok, "01", "TM"),
                             Desember_Real = (double)g.Where(o => o.Bulan == 12).Sum(o => o.KgTBS) / (double)CRUDRef_Areal.CRUD.HitungLuasArealKebun(g.Key.KodeBlok, "01", "TM"),

                             Januari_PTPN8 = (double)(CRUDHasilPanen.CRUD.GetHasilPanenPerKebun().Where(o => o.KodeBudidaya == "01" && o.Bulan == 1).Sum(o => o.KgTBS)) / (double)CRUDRef_Areal.CRUD.HitungLuasArealPTPN8("01", "TM"),
                             Februari_PTPN8 = (double)(CRUDHasilPanen.CRUD.GetHasilPanenPerKebun().Where(o => o.KodeBudidaya == "01" && o.Bulan == 2).Sum(o => o.KgTBS)) / (double)CRUDRef_Areal.CRUD.HitungLuasArealPTPN8("01", "TM"),
                             Maret_PTPN8 = (double)(CRUDHasilPanen.CRUD.GetHasilPanenPerKebun().Where(o => o.KodeBudidaya == "01" && o.Bulan == 3).Sum(o => o.KgTBS)) / (double)CRUDRef_Areal.CRUD.HitungLuasArealPTPN8("01", "TM"),
                             April_PTPN8 = (double)(CRUDHasilPanen.CRUD.GetHasilPanenPerKebun().Where(o => o.KodeBudidaya == "01" && o.Bulan == 4).Sum(o => o.KgTBS)) / (double)CRUDRef_Areal.CRUD.HitungLuasArealPTPN8("01", "TM"),
                             Mei_PTPN8 = (double)(CRUDHasilPanen.CRUD.GetHasilPanenPerKebun().Where(o => o.KodeBudidaya == "01" && o.Bulan == 5).Sum(o => o.KgTBS)) / (double)CRUDRef_Areal.CRUD.HitungLuasArealPTPN8("01", "TM"),
                             Juni_PTPN8 = (double)(CRUDHasilPanen.CRUD.GetHasilPanenPerKebun().Where(o => o.KodeBudidaya == "01" && o.Bulan == 6).Sum(o => o.KgTBS)) / (double)CRUDRef_Areal.CRUD.HitungLuasArealPTPN8("01", "TM"),
                             Juli_PTPN8 = (double)(CRUDHasilPanen.CRUD.GetHasilPanenPerKebun().Where(o => o.KodeBudidaya == "01" && o.Bulan == 7).Sum(o => o.KgTBS)) / (double)CRUDRef_Areal.CRUD.HitungLuasArealPTPN8("01", "TM"),
                             Agustus_PTPN8 = (double)(CRUDHasilPanen.CRUD.GetHasilPanenPerKebun().Where(o => o.KodeBudidaya == "01" && o.Bulan == 8).Sum(o => o.KgTBS)) / (double)CRUDRef_Areal.CRUD.HitungLuasArealPTPN8("01", "TM"),
                             September_PTPN8 = (double)(CRUDHasilPanen.CRUD.GetHasilPanenPerKebun().Where(o => o.KodeBudidaya == "01" && o.Bulan == 9).Sum(o => o.KgTBS)) / (double)CRUDRef_Areal.CRUD.HitungLuasArealPTPN8("01", "TM"),
                             Oktober_PTPN8 = (double)(CRUDHasilPanen.CRUD.GetHasilPanenPerKebun().Where(o => o.KodeBudidaya == "01" && o.Bulan == 10).Sum(o => o.KgTBS)) / (double)CRUDRef_Areal.CRUD.HitungLuasArealPTPN8("01", "TM"),
                             November_PTPN8 = (double)(CRUDHasilPanen.CRUD.GetHasilPanenPerKebun().Where(o => o.KodeBudidaya == "01" && o.Bulan == 11).Sum(o => o.KgTBS)) / (double)CRUDRef_Areal.CRUD.HitungLuasArealPTPN8("01", "TM"),
                             Desember_PTPN8 = (double)(CRUDHasilPanen.CRUD.GetHasilPanenPerKebun().Where(o => o.KodeBudidaya == "01" && o.Bulan == 12).Sum(o => o.KgTBS)) / (double)CRUDRef_Areal.CRUD.HitungLuasArealPTPN8("01", "TM")
                         }).ToList();
        ...
        public ActionResult ProtasPerKebun([DataSourceRequest]DataSourceRequest request, string Id = "", string budidaya = "", string tahun = "", string bulan = "")
        {
            ...
            var model1 = (from m in CRUDHasilPanen.CRUD.GetHasilPanenPerKebunPer6Bulan().Where(o => o.KodeBudidaya == "01")
                         ...
                         select new ProduktivitasPerKebun
                         {
                             ...
                             Budidaya = "Sawit",
                             LuasAreal = CRUDRef_Areal.CRUD.HitungLuasArealKebun(g.Key.g1, "01", "TM", g.Key.g2),
                             LuasArealInduk = CRUDRef_Areal.CRUD.HitungLuasArealPTPN8("01", "TM", g.Key.g2),
                             Januari_Real = (double) g.Where(o => o.Bulan == 1).Sum(o => o.KgTBS), 
                             Februari_Real = (double)g.Where(o => o.Bulan == 2).Sum(o => o.KgTBS), 
                             Maret_Real = (double)g.Where(o => o.Bulan == 3).Sum(o => o.KgTBS),
                             April_Real = (double)g.Where(o => o.Bulan == 4).Sum(o => o.KgTBS),
                             Mei_Real = (double)g.Where(o => o.Bulan == 5).Sum(o => o.KgTBS),
                             Juni_Real = (double)g.Where(o => o.Bulan == 6).Sum(o => o.KgTBS),
                             Juli_Real = (double)g.Where(o => o.Bulan == 7).Sum(o => o.KgTBS),
                             Agustus_Real = (double)g.Where(o => o.Bulan == 8).Sum(o => o.KgTBS),
                             September_Real = (double)g.Where(o => o.Bulan == 9).Sum(o => o.KgTBS),
                             Oktober_Real = (double)g.Where(o => o.Bulan == 10).Sum(o => o.KgTBS),
                             November_Real = (double)g.Where(o => o.Bulan == 11).Sum(o => o.KgTBS),
                             Desember_Real = (double)g.Where(o => o.Bulan == 12).Sum(o => o.KgTBS),
                         }).ToList();
        ...
        public ActionResult KebunGeoJSon(string Id = "", string budidaya = "", string tahun = "", string bulan = "", string warna = "", string perbandingan = "", string pctBalai = "100")
        {
            ...
            var model1 = (from m in CRUDHasilPanen.CRUD.GetHasilPanenPerKebunPer6Bulan().Where(o => o.KodeBudidaya == "01")
                          ...
                          select new ProduktivitasPerKebun
                          {
                              ...
                              Budidaya = "Sawit",
                              TahunTanam = string.Join(",", g.Select(o => o.TahunTanam).ToArray()),
                              LuasAreal = CRUDRef_Areal.CRUD.HitungLuasArealKebun(g.Key.g1, "01", "TM"),
                              LuasArealInduk = CRUDRef_Areal.CRUD.HitungLuasArealPTPN8("01", "TM"),
                              Januari_Real = (double)g.Where(o => o.Bulan == 1).Sum(o => o.KgTBS),
                              Februari_Real = (double)g.Where(o => o.Bulan == 2).Sum(o => o.KgTBS),
                              Maret_Real = (double)g.Where(o => o.Bulan == 3).Sum(o => o.KgTBS),
                              April_Real = (double)g.Where(o => o.Bulan == 4).Sum(o => o.KgTBS),
        ...
        public ActionResult ChartProtasPerAfdeling(string Id = "", string budidaya = "", string tahun = "", string bulan = "", string perbandingan = "", string pctBalai = "100")
        {
            ...
            var model = (from m in CRUDHasilPanen.CRUD.GetHasilPanenPerAfdelingPer6Bulan().Where(o => o.KodeBudidaya == "01" && o.KodeBlok.Substring(0,2)==Id)
                         group m by new { m.KodeBlok } into g
                         select new ProduktivitasPerAfdeling
                         {
                             ...
                             Januari_Real = (double)g.Where(o => o.Bulan == 1).Sum(o => o.KgTBS) / (double)CRUDRef_Areal.CRUD.HitungLuasArealAfdeling(g.Key.KodeBlok, "01", "TM"),
                             Februari_Real = (double)g.Where(o => o.Bulan == 2).Sum(o => o.KgTBS) / (double)CRUDRef_Areal.CRUD.HitungLuasArealAfdeling(g.Key.KodeBlok, "01", "TM"),
                             Maret_Real = (double)g.Where(o => o.Bulan == 3).Sum(o => o.KgTBS) / (double)CRUDRef_Areal.CRUD.HitungLuasArealAfdeling(g.Key.KodeBlok, "01", "TM"),
                             April_Real = (double)g.Where(o => o.Bulan == 4).Sum(o => o.KgTBS) / (double)CRUDRef_Areal.CRUD.HitungLuasArealAfdeling(g.Key.KodeBlok, "01", "TM"),
                             Mei_Real = (double)g.Where(o => o.Bulan == 5).Sum(o => o.KgTBS) / (double)CRUDRef_Areal.CRUD.HitungLuasArealAfdeling(g.Key.KodeBlok, "01", "TM"),
                             Juni_Real = (double)g.Where(o => o.Bulan == 6).Sum(o => o.KgTBS) / (double)CRUDRef_Areal.CRUD.HitungLuasArealAfdeling(g.Key.KodeBlok, "01", "TM"),
                             Juli_Real = (double)g.Where(o => o.Bulan == 7).Sum(o => o.KgTBS) / (double)CRUDRef_Areal.CRUD.HitungLuasArealAfdeling(g.Key.KodeBlok, "01", "TM"),
                             Agustus_Real = (double)g.Where(o => o.Bulan == 8).Sum(o => o.KgTBS) / (double)CRUDRef_Areal.CRUD.HitungLuasArealAfdeling(g.Key.KodeBlok, "01", "TM"),
                             September_Real = (double)g.Where(o => o.Bulan == 9).Sum(o => o.KgTBS) / (double)CRUDRef_Areal.CRUD.HitungLuasArealAfdeling(g.Key.KodeBlok, "01", "TM"),
                             Oktober_Real = (double)g.Where(o => o.Bulan == 10).Sum(o => o.KgTBS) / (double)CRUDRef_Areal.CRUD.HitungLuasArealAfdeling(g.Key.KodeBlok, "01", "TM"),
                             November_Real = (double)g.Where(o => o.Bulan == 11).Sum(o => o.KgTBS) / (double)CRUDRef_Areal.CRUD.HitungLuasArealAfdeling(g.Key.KodeBlok, "01", "TM"),
                             Desember_Real = (double)g.Where(o => o.Bulan == 12).Sum(o => o.KgTBS) / (double)CRUDRef_Areal.CRUD.HitungLuasArealAfdeling(g.Key.KodeBlok, "01", "TM"),

                             Januari_PTPN8 = (double)(CRUDHasilPanen.CRUD.GetHasilPanenPerKebun().Where(o => o.KodeBudidaya == "01" && o.Bulan == 1 && o.KodeBlok == g.Key.KodeBlok.Substring(0,2) ).Sum(o => o.KgTBS)) / (double)CRUDRef_Areal.CRUD.HitungLuasArealKebun(g.Key.KodeBlok.Substring(0,2),"01", "TM"),
                             Februari_PTPN8 = (double)(CRUDHasilPanen.CRUD.GetHasilPanenPerKebun().Where(o => o.KodeBudidaya == "01" && o.Bulan == 2 && o.KodeBlok == g.Key.KodeBlok.Substring(0, 2)).Sum(o => o.KgTBS)) / (double)CRUDRef_Areal.CRUD.HitungLuasArealKebun(g.Key.KodeBlok.Substring(0, 2), "01", "TM"),
                             Maret_PTPN8 = (double)(CRUDHasilPanen.CRUD.GetHasilPanenPerKebun().Where(o => o.KodeBudidaya == "01" && o.Bulan == 3 && o.KodeBlok == g.Key.KodeBlok.Substring(0, 2)).Sum(o => o.KgTBS)) / (double)CRUDRef_Areal.CRUD.HitungLuasArealKebun(g.Key.KodeBlok.Substring(0, 2), "01", "TM"),
                             April_PTPN8 = (double)(CRUDHasilPanen.CRUD.GetHasilPanenPerKebun().Where(o => o.KodeBudidaya == "01" && o.Bulan == 4 && o.KodeBlok == g.Key.KodeBlok.Substring(0, 2)).Sum(o => o.KgTBS)) / (double)CRUDRef_Areal.CRUD.HitungLuasArealKebun(g.Key.KodeBlok.Substring(0, 2), "01", "TM"),
                             Mei_PTPN8 = (double)(CRUDHasilPanen.CRUD.GetHasilPanenPerKebun().Where(o => o.KodeBudidaya == "01" && o.Bulan == 5 && o.KodeBlok == g.Key.KodeBlok.Substring(0, 2)).Sum(o => o.KgTBS)) / (double)CRUDRef_Areal.CRUD.HitungLuasArealKebun(g.Key.KodeBlok.Substring(0, 2), "01", "TM"),
                             Juni_PTPN8 = (double)(CRUDHasilPanen.CRUD.GetHasilPanenPerKebun().Where(o => o.KodeBudidaya == "01" && o.Bulan == 6 && o.KodeBlok == g.Key.KodeBlok.Substring(0, 2)).Sum(o => o.KgTBS)) / (double)CRUDRef_Areal.CRUD.HitungLuasArealKebun(g.Key.KodeBlok.Substring(0, 2), "01", "TM"),
                             Juli_PTPN8 = (double)(CRUDHasilPanen.CRUD.GetHasilPanenPerKebun().Where(o => o.KodeBudidaya == "01" && o.Bulan == 7 && o.KodeBlok == g.Key.KodeBlok.Substring(0, 2)).Sum(o => o.KgTBS)) / (double)CRUDRef_Areal.CRUD.HitungLuasArealKebun(g.Key.KodeBlok.Substring(0, 2), "01", "TM"),
                             Agustus_PTPN8 = (double)(CRUDHasilPanen.CRUD.GetHasilPanenPerKebun().Where(o => o.KodeBudidaya == "01" && o.Bulan == 8 && o.KodeBlok == g.Key.KodeBlok.Substring(0, 2)).Sum(o => o.KgTBS)) / (double)CRUDRef_Areal.CRUD.HitungLuasArealKebun(g.Key.KodeBlok.Substring(0, 2), "01", "TM"),
                             September_PTPN8 = (double)(CRUDHasilPanen.CRUD.GetHasilPanenPerKebun().Where(o => o.KodeBudidaya == "01" && o.Bulan == 9 && o.KodeBlok == g.Key.KodeBlok.Substring(0, 2)).Sum(o => o.KgTBS)) / (double)CRUDRef_Areal.CRUD.HitungLuasArealKebun(g.Key.KodeBlok.Substring(0, 2), "01", "TM"),
                             Oktober_PTPN8 = (double)(CRUDHasilPanen.CRUD.GetHasilPanenPerKebun().Where(o => o.KodeBudidaya == "01" && o.Bulan == 10 && o.KodeBlok == g.Key.KodeBlok.Substring(0, 2)).Sum(o => o.KgTBS)) / (double)CRUDRef_Areal.CRUD.HitungLuasArealKebun(g.Key.KodeBlok.Substring(0, 2), "01", "TM"),
                             November_PTPN8 = (double)(CRUDHasilPanen.CRUD.GetHasilPanenPerKebun().Where(o => o.KodeBudidaya == "01" && o.Bulan == 11 && o.KodeBlok == g.Key.KodeBlok.Substring(0, 2)).Sum(o => o.KgTBS)) / (double)CRUDRef_Areal.CRUD.HitungLuasArealKebun(g.Key.KodeBlok.Substring(0, 2), "01", "TM"),
                             Desember_PTPN8 = (double)(CRUDHasilPanen.CRUD.GetHasilPanenPerKebun().Where(o => o.KodeBudidaya == "01" && o.Bulan == 12 && o.KodeBlok == g.Key.KodeBlok.Substring(0, 2)).Sum(o => o.KgTBS)) / (double)CRUDRef_Areal.CRUD.HitungLuasArealKebun(g.Key.KodeBlok.Substring(0, 2), "01", "TM")
                         }).ToList();
        ...
        public ActionResult ProtasPerAfdeling([DataSourceRequest]DataSourceRequest request, string Id = "", string budidaya = "", string tahun = "", string bulan = "", string perbandingan = "", string pctBalai = "100")
        {
            ...
            var model1 = (from m in CRUDHasilPanen.CRUD.GetHasilPanenPerAfdelingPer6Bulan().Where(o => o.KodeBudidaya == "01" && o.KodeBlok.Substring(0,2)==Id)
                          group m by new { g1 = m.KodeBlok, g2 = m.TahunTanam } into g
                          select new ProduktivitasPerAfdeling
                          {
                              ...
                              TahunTanam = g.Key.g2,
                              Budidaya = "Sawit",
                              LuasAreal = CRUDRef_Areal.CRUD.HitungLuasArealAfdeling(g.Key.g1, "01", "TM", g.Key.g2),
                              LuasArealInduk = CRUDRef_Areal.CRUD.HitungLuasArealKebun(g.Key.g1.Substring(0,2),"01","TM", g.Key.g2),
                              Januari_Real = (double)g.Where(o => o.Bulan == 1).Sum(o => o.KgTBS),
                              Februari_Real = (double)g.Where(o => o.Bulan == 2).Sum(o => o.KgTBS),
                              Maret_Real = (double)g.Where(o => o.Bulan == 3).Sum(o => o.KgTBS),
                              April_Real = (double)g.Where(o => o.Bulan == 4).Sum(o => o.KgTBS),
        ...
        public ActionResult AfdelingGeoJSon(string Id = "", string budidaya = "", string tahun = "", string bulan = "", string warna = "", string perbandingan = "", string pctBalai = "100")
        {
            ...
            var model1 = (from m in CRUDHasilPanen.CRUD.GetHasilPanenPerAfdelingPer6Bulan().Where(o => o.KodeBudidaya == "01" && o.KodeBlok.Substring(0,2)==Id)
                          ...
                          select new ProduktivitasPerAfdeling
                          {
                              ...
                              Budidaya = "Sawit",
                              TahunTanam = string.Join(",", g.Select(o => o.TahunTanam).ToArray()),
                              LuasAreal = CRUDRef_Areal.CRUD.HitungLuasArealAfdeling(g.Key.g1, "01", "TM"),
                              LuasArealInduk = CRUDRef_Areal.CRUD.HitungLuasArealKebun(g.Key.g1.Substring(0,2),"01", "TM"),
                              Januari_Real = (double)g.Where(o => o.Bulan == 1).Sum(o => o.KgTBS),
                              Februari_Real = (double)g.Where(o => o.Bulan == 2).Sum(o => o.KgTBS),
                              Maret_Real = (double)g.Where(o => o.Bulan == 3).Sum(o => o.KgTBS),
                              April_Real = (double)g.Where(o => o.Bulan == 4).Sum(o => o.KgTBS),
        ...
        public ActionResult ChartProtasPerBlok(string Id = "", string budidaya = "", string tahun = "", string bulan = "", string perbandingan = "", string pctBalai = "100")
        {
            ...
            var model = (from m in CRUDHasilPanen.CRUD.GetHasilPanenPerBlokPer6Bulan().Where(o => o.KodeBudidaya == "01" && o.KodeBlok.Substring(0, 4) == Id)
                         group m by new { m.KodeBlok } into g
                         select new ProduktivitasPerBlok
                         {
                             ...
                             Blok = CRUDRef_Areal.CRUD.Get1Record(g.Key.KodeBlok, "01", "TM") == null ? "" : CRUDRef_Areal.CRUD.Get1Record(g.Key.KodeBlok, "01", "TM").namablok,
                             ...
                             Januari_Real = (double)g.Where(o => o.Bulan == 1).Sum(o => o.KgTBS) / (double)CRUDRef_Areal.CRUD.HitungLuasArealBlok(g.Key.KodeBlok, "01", "TM"),
                             Februari_Real = (double)g.Where(o => o.Bulan == 2).Sum(o => o.KgTBS) / (double)CRUDRef_Areal.CRUD.HitungLuasArealBlok(g.Key.KodeBlok, "01", "TM"),
                             Maret_Real = (double)g.Where(o => o.Bulan == 3).Sum(o => o.KgTBS) / (double)CRUDRef_Areal.CRUD.HitungLuasArealBlok(g.Key.KodeBlok, "01", "TM"),
                             April_Real = (double)g.Where(o => o.Bulan == 4).Sum(o => o.KgTBS) / (double)CRUDRef_Areal.CRUD.HitungLuasArealBlok(g.Key.KodeBlok, "01", "TM"),
                             Mei_Real = (double)g.Where(o => o.Bulan == 5).Sum(o => o.KgTBS) / (double)CRUDRef_Areal.CRUD.HitungLuasArealBlok(g.Key.KodeBlok, "01", "TM"),
                             Juni_Real = (double)g.Where(o => o.Bulan == 6).Sum(o => o.KgTBS) / (double)CRUDRef_Areal.CRUD.HitungLuasArealBlok(g.Key.KodeBlok, "01", "TM"),
                             Juli_Real = (double)g.Where(o => o.Bulan == 7).Sum(o => o.KgTBS) / (double)CRUDRef_Areal.CRUD.HitungLuasArealBlok(g.Key.KodeBlok, "01", "TM"),
                             Agustus_Real = (double)g.Where(o => o.Bulan == 8).Sum(o => o.KgTBS) / (double)CRUDRef_Areal.CRUD.HitungLuasArealBlok(g.Key.KodeBlok, "01", "TM"),
                             September_Real = (double)g.Where(o => o.Bulan == 9).Sum(o => o.KgTBS) / (double)CRUDRef_Areal.CRUD.HitungLuasArealBlok(g.Key.KodeBlok, "01", "TM"),
                             Oktober_Real = (double)g.Where(o => o.Bulan == 10).Sum(o => o.KgTBS) / (double)CRUDRef_Areal.CRUD.HitungLuasArealBlok(g.Key.KodeBlok, "01", "TM"),
                             November_Real = (double)g.Where(o => o.Bulan == 11).Sum(o => o.KgTBS) / (double)CRUDRef_Areal.CRUD.HitungLuasArealBlok(g.Key.KodeBlok, "01", "TM"),
                             Desember_Real = (double)g.Where(o => o.Bulan == 12).Sum(o => o.KgTBS) / (double)CRUDRef_Areal.CRUD.HitungLuasArealBlok(g.Key.KodeBlok, "01", "TM"),

                             Januari_PTPN8 = (double)(CRUDHasilPanen.CRUD.GetHasilPanenPerAfdeling().Where(o => o.KodeBudidaya == "01" && o.Bulan == 1 && o.KodeBlok == g.Key.KodeBlok.Substring(0, 4)).Sum(o => o.KgTBS)) / (double)CRUDRef_Areal.CRUD.HitungLuasArealAfdeling(g.Key.KodeBlok.Substring(0, 4), "01", "TM"),
                             Februari_PTPN8 = (double)(CRUDHasilPanen.CRUD.GetHasilPanenPerAfdeling().Where(o => o.KodeBudidaya == "01" && o.Bulan == 2 && o.KodeBlok == g.Key.KodeBlok.Substring(0, 4)).Sum(o => o.KgTBS)) / (double)CRUDRef_Areal.CRUD.HitungLuasArealAfdeling(g.Key.KodeBlok.Substring(0, 4), "01", "TM"),
                             Maret_PTPN8 = (double)(CRUDHasilPanen.CRUD.GetHasilPanenPerAfdeling().Where(o => o.KodeBudidaya == "01" && o.Bulan == 3 && o.KodeBlok == g.Key.KodeBlok.Substring(0, 4)).Sum(o => o.KgTBS)) / (double)CRUDRef_Areal.CRUD.HitungLuasArealAfdeling(g.Key.KodeBlok.Substring(0, 4), "01", "TM"),
                             April_PTPN8 = (double)(CRUDHasilPanen.CRUD.GetHasilPanenPerAfdeling().Where(o => o.KodeBudidaya == "01" && o.Bulan == 4 && o.KodeBlok == g.Key.KodeBlok.Substring(0, 4)).Sum(o => o.KgTBS)) / (double)CRUDRef_Areal.CRUD.HitungLuasArealAfdeling(g.Key.KodeBlok.Substring(0, 4), "01", "TM"),
                             Mei_PTPN8 = (double)(CRUDHasilPanen.CRUD.GetHasilPanenPerAfdeling().Where(o => o.KodeBudidaya == "01" && o.Bulan == 5 && o.KodeBlok == g.Key.KodeBlok.Substring(0, 4)).Sum(o => o.KgTBS)) / (double)CRUDRef_Areal.CRUD.HitungLuasArealAfdeling(g.Key.KodeBlok.Substring(0, 4), "01", "TM"),
                             Juni_PTPN8 = (double)(CRUDHasilPanen.CRUD.GetHasilPanenPerAfdeling().Where(o => o.KodeBudidaya == "01" && o.Bulan == 6 && o.KodeBlok == g.Key.KodeBlok.Substring(0, 4)).Sum(o => o.KgTBS)) / (double)CRUDRef_Areal.CRUD.HitungLuasArealAfdeling(g.Key.KodeBlok.Substring(0, 4), "01", "TM"),
                             Juli_PTPN8 = (double)(CRUDHasilPanen.CRUD.GetHasilPanenPerAfdeling().Where(o => o.KodeBudidaya == "01" && o.Bulan == 7 && o.KodeBlok == g.Key.KodeBlok.Substring(0, 4)).Sum(o => o.KgTBS)) / (double)CRUDRef_Areal.CRUD.HitungLuasArealAfdeling(g.Key.KodeBlok.Substring(0, 4), "01", "TM"),
                             Agustus_PTPN8 = (double)(CRUDHasilPanen.CRUD.GetHasilPanenPerAfdeling().Where(o => o.KodeBudidaya == "01" && o.Bulan == 8 && o.KodeBlok == g.Key.KodeBlok.Substring(0, 4)).Sum(o => o.KgTBS)) / (double)CRUDRef_Areal.CRUD.HitungLuasArealAfdeling(g.Key.KodeBlok.Substring(0, 4), "01", "TM"),
                             September_PTPN8 = (double)(CRUDHasilPanen.CRUD.GetHasilPanenPerAfdeling().Where(o => o.KodeBudidaya == "01" && o.Bulan == 9 && o.KodeBlok == g.Key.KodeBlok.Substring(0, 4)).Sum(o => o.KgTBS)) / (double)CRUDRef_Areal.CRUD.HitungLuasArealAfdeling(g.Key.KodeBlok.Substring(0, 4), "01", "TM"),
                             Oktober_PTPN8 = (double)(CRUDHasilPanen.CRUD.GetHasilPanenPerAfdeling().Where(o => o.KodeBudidaya == "01" && o.Bulan == 10 && o.KodeBlok == g.Key.KodeBlok.Substring(0, 4)).Sum(o => o.KgTBS)) / (double)CRUDRef_Areal.CRUD.HitungLuasArealAfdeling(g.Key.KodeBlok.Substring(0, 4), "01", "TM"),
                             November_PTPN8 = (double)(CRUDHasilPanen.CRUD.GetHasilPanenPerAfdeling().Where(o => o.KodeBudidaya == "01" && o.Bulan == 11 && o.KodeBlok == g.Key.KodeBlok.Substring(0, 4)).Sum(o => o.KgTBS)) / (double)CRUDRef_Areal.CRUD.HitungLuasArealAfdeling(g.Key.KodeBlok.Substring(0, 4), "01", "TM"),
                             Desember_PTPN8 = (double)(CRUDHasilPanen.CRUD.GetHasilPanenPerAfdeling().Where(o => o.KodeBudidaya == "01" && o.Bulan == 12 && o.KodeBlok == g.Key.KodeBlok.Substring(0, 4)).Sum(o => o.KgTBS)) / (double)CRUDRef_Areal.CRUD.HitungLuasArealAfdeling(g.Key.KodeBlok.Substring(0, 4), "01", "TM"),
                         }).ToList();
        ...
        public ActionResult ProtasPerBlok([DataSourceRequest]DataSourceRequest request, string Id = "", string budidaya = "", string tahun = "", string bulan = "", string perbandingan = "", string pctBalai = "100")
        {
            ...
            var model1 = (from m in CRUDHasilPanen.CRUD.GetHasilPanenPerBlokPer6Bulan().Where(o => o.KodeBudidaya == "01" && o.KodeBlok.Substring(0, 4) == Id)
                          group m by new { g1 = m.KodeBlok, g2 = m.TahunTanam } into g
                          select new ProduktivitasPerBlok
                          {
                              Id = CRUDBlok.CRUD.Get1Record(g.Key.g1) == null ? Guid.Empty : CRUDBlok.CRUD.Get1Record(g.Key.g1).BlokId,
                              Blok = CRUDRef_Areal.CRUD.Get1Record(g.Key.g1,"01","TM") == null ? "" : CRUDRef_Areal.CRUD.Get1Record(g.Key.g1, "01", "TM").namablok,
                              Afdeling = CRUDBlok.CRUD.Get1Record(g.Key.g1) == null ? "" : CRUDBlok.CRUD.Get1Record(g.Key.g1).Afdeling.Nama,
                              TahunTanam = g.Key.g2,
                              Budidaya = "Sawit",
                              LuasAreal = CRUDRef_Areal.CRUD.HitungLuasArealBlok(g.Key.g1, "01", "TM", g.Key.g2),
                              LuasArealInduk = CRUDRef_Areal.CRUD.HitungLuasArealAfdeling(g.Key.g1.Substring(0, 4),"01", "TM", g.Key.g2),
                              Januari_Real = (double)g.Where(o => o.Bulan == 1).Sum(o => o.KgTBS),
                              Februari_Real = (double)g.Where(o => o.Bulan == 2).Sum(o => o.KgTBS),
                              Maret_Real = (double)g.Where(o => o.Bulan == 3).Sum(o => o.KgTBS),
                              April_Real = (double)g.Where(o => o.Bulan == 4).Sum(o => o.KgTBS),
        ...
        public ActionResult BlokGeoJSon(string Id = "", string budidaya = "", string tahun = "", string bulan = "", string warna = "", string perbandingan = "", string pctBalai = "100")
        {
            ...
            var model1 = (from m in CRUDHasilPanen.CRUD.GetHasilPanenPerBlokPer6Bulan().Where(o => o.KodeBudidaya == "01" && o.KodeBlok.Substring(0, 4) == Id)
                          ...
                          select new ProduktivitasPerBlok
                          {
                              ...
                              Budidaya = "Sawit",
                              TahunTanam = string.Join(",", g.Select(o => o.TahunTanam).ToArray()),
                              LuasAreal = CRUDRef_Areal.CRUD.HitungLuasArealBlok(g.Key.g1, "01", "TM"),
                              LuasArealInduk = CRUDRef_Areal.CRUD.HitungLuasArealAfdeling(g.Key.g1.Substring(0, 4),"01", "TM"),
                              Januari_Real = (double)g.Where(o => o.Bulan == 1).Sum(o => o.KgTBS),
                              Februari_Real = (double)g.Where(o => o.Bulan == 2).Sum(o => o.KgTBS),
                              Maret_Real = (double)g.Where(o => o.Bulan == 3).Sum(o => o.KgTBS),
                              April_Real = (double)g.Where(o => o.Bulan == 4).Sum(o => o.KgTBS),
