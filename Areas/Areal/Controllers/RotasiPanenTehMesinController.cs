...
{
    public class RotasiPanenTehMesinController : Controller
    {
        ...
        public ActionResult ChartRotasiPerKebun(string Id = "", string budidaya = "", string tahun = "", string bulan = "", string perbandingan = "", string pctBalai = "100")
        {
            ...
            {
                o.JumlahPohon = o.T01JumlahPohon + o.T02JumlahPohon + o.T03JumlahPohon + o.T04JumlahPohon + o.T05JumlahPohon +
                ...
                o.TotalJumlahHK = o.T01JumlahHK + o.T02JumlahHK + o.T03JumlahHK + o.T04JumlahHK + o.T05JumlahHK +
            ...
            var kebun = from m in blok
                        ...
                        select new RotasiPanenPerBulan
                        {
                            ...
                            KodeBudidaya = "02",
                            NamaBudidaya = "Teh",
                            JumlahRotasi = g.Sum(o => o.TotalJumlahHK)>0?g.Sum(o=>o.JumlahPohon)/g.Sum(o=>o.TotalJumlahHK):0,
                        };
        ...
        public ActionResult RotasiPerKebun([DataSourceRequest]DataSourceRequest request, string Id = "", string budidaya = "", string tahun = "", string bulan = "", string perbandingan = "", string pctBalai = "100")
        {
            ...
            var kebun = from m in blok
                        group m by new { g1 = m.KodeLokasi.Substring(0, 2), g2 = m.TahunTanam } into g
                        select new RotasiPanenPerTahun
                        {
                            ...
                            JumlahPohon = g.Sum(o => o.T01JumlahPohon + o.T02JumlahPohon + o.T03JumlahPohon + o.T04JumlahPohon + o.T05JumlahPohon +
                                o.T06JumlahPohon + o.T07JumlahPohon + o.T08JumlahPohon + o.T09JumlahPohon + o.T10JumlahPohon +
                                o.T11JumlahPohon + o.T12JumlahPohon + o.T13JumlahPohon + o.T14JumlahPohon + o.T15JumlahPohon +
                                o.T16JumlahPohon + o.T17JumlahPohon + o.T18JumlahPohon + o.T19JumlahPohon + o.T20JumlahPohon +
                                o.T21JumlahPohon + o.T22JumlahPohon + o.T23JumlahPohon + o.T24JumlahPohon + o.T25JumlahPohon +
            ...
            List<RotasiPanenPerTahun> mdl = new List<RotasiPanenPerTahun>();
            foreach (var m in kebun)
            {
                ...
                var normaRotasi = CRUDStandardProduktivitasTeh.CRUD.Get1Record(dataran).LuasJelajah;
                if (m.TotalJumlahHK > 0)
                {
                    if (m.JumlahPohon/m.TotalJumlahHK <= normaRotasi*70/100)
                        m.Warna = "red";
                    else if (m.JumlahPohon / m.TotalJumlahHK <= normaRotasi * 80 / 100)
                        m.Warna = "orange";
                    else if (m.JumlahPohon / m.TotalJumlahHK <= normaRotasi * 90 / 100)
                        m.Warna = "yellow";
                    else if ( m.JumlahPohon/m.TotalJumlahHK <= normaRotasi)
                        m.Warna = "green";
                    else
                        m.Warna = "blue";
                }
            ...
            foreach (var m in model1)
            {
                ...
                for (int i = 0; i < strTahunTanam.Length; i++)
                {
                    normaRotasi = normaRotasi + (CRUDStandardProduktivitasTeh.CRUD.GetAllRecord().FirstOrDefault(o => o.Dataran == dataran) != null ?
                            CRUDStandardProduktivitasTeh.CRUD.GetAllRecord().FirstOrDefault(o => o.Dataran == dataran).LuasJelajah : 0);
                }

                jumlahRotasi = blok.Where(o => o.KodeLokasi.Substring(0, 2) == m.KodeKebun).Count() > 0 ? blok.Where(o => o.KodeLokasi.Substring(0, 2) == m.KodeKebun).Sum(o => o.JumlahPohon) : 0;
                jumlahHK = blok.Where(o => o.KodeLokasi.Substring(0, 2) == m.KodeKebun).Count() > 0 ? blok.Where(o => o.KodeLokasi.Substring(0, 2) == m.KodeKebun).Sum(o => o.TotalJumlahHK) : 0;
                ...
                if (warna == "")
                {
                    if (jumlahHK > 0)
                    {
                        m.Value1 = (double)jumlahRotasi / (double)jumlahHK;
                        m.Value2 = (double)normaRotasi;

                        if (jumlahRotasi / jumlahHK <= normaRotasi * 70 / 100)
                            m.Warna = "red";
                        else if (jumlahRotasi / jumlahHK <= normaRotasi * 80 / 100)
                            m.Warna = "orange";
                        else if (jumlahRotasi / jumlahHK <= normaRotasi * 90 / 100)
                            m.Warna = "yellow";
                        else if (jumlahRotasi / jumlahHK <= normaRotasi)
                            m.Warna = "green";
                        else
                            m.Warna = "blue";
                    }
        ...
        public ActionResult RotasiPerAfdeling([DataSourceRequest]DataSourceRequest request, string Id = "", string budidaya = "", string tahun = "", string bulan = "", string perbandingan = "", string pctBalai = "100")
        {
            ...
            var afdeling = from m in blok
                           group m by new { g1 = m.KodeLokasi.Substring(0, 4), g2 = m.TahunTanam } into g
                           select new RotasiPanenPerBulan
                           {
        ...
        public ActionResult AfdelingGeoJSon(string Id = "", string budidaya = "", string tahun = "", string bulan = "", string warna = "", string perbandingan = "", string pctBalai = "100")
        {
            ...
            foreach (var m in model1)
            {
                ...
                jumlahRotasi = blok.Where(o => o.KodeLokasi.Substring(0, 4) == m.KodeKebun).Count() > 0 ? blok.Where(o => o.KodeLokasi.Substring(0, 4) == m.KodeKebun).Average(o => o.JumlahPohon) : 0;
                jumlahHK = blok.Where(o => o.KodeLokasi.Substring(0, 4) == m.KodeKebun).Count() > 0 ? (decimal)blok.Where(o => o.KodeLokasi.Substring(0, 4) == m.KodeKebun).Average(o => o.TotalJumlahHK) : 0;
        ...
        public ActionResult RotasiPerBlok([DataSourceRequest]DataSourceRequest request, string Id = "", string budidaya = "", string tahun = "", string bulan = "", string perbandingan = "", string pctBalai = "100")
        {
            ...
            var blok1 = from m in blok
                        group m by new { g1 = m.KodeLokasi, g2 = m.TahunTanam } into g
                        select new RotasiPanenPerBulan
                        {
        ...
        public ActionResult BlokGeoJSon(string Id = "", string budidaya = "", string tahun = "", string bulan = "", string warna = "", string perbandingan = "", string pctBalai = "100")
        {
            ...
            foreach (var m in model1)
            {
                ...
                jumlahRotasi = blok.Where(o => o.KodeLokasi == m.KodeKebun).Count() > 0 ? blok.Where(o => o.KodeLokasi == m.KodeKebun).Average(o => o.JumlahPohon) : 0;
                jumlahHK = blok.Where(o => o.KodeLokasi == m.KodeKebun).Count() > 0 ? (decimal)blok.Where(o => o.KodeLokasi == m.KodeKebun).Average(o => o.TotalJumlahHK) : 0;
                if (strTahunTanam.Length > 0)
                {
                    normaRotasi = normaRotasi / strTahunTanam.Length;
                }
