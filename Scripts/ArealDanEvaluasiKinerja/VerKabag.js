var hdr_UpdateDHBBId
var detailBaru = false;
var username;
var menuId = 'B9873975-B098-4868-BB83-EF3A8091CF71'
...
function grdOnEdit(e) {
    ...
    if (model.isNew()) {
        model.id = model.uid;
        e.container.find("input[name=HDR_UpdateDHBBId]").val(model.id).change();
    }
    hdr_UpdateDHBBId = model.id;
