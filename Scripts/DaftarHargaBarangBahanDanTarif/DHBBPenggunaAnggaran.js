...
var menuId = '469A28BE-E012-46B5-B4D3-38880D85AF38';
...
function getDataFrom() {
    ...
    return $.ajax({
        url: url,
        data: {
            scriptSQL: "Select COUNT(*) as JmlRecord from SPDK_KanpusEF.dbo.EvaluasiDHBB as A " +
                "join SPDK_KanpusEF.dbo.DTL_TerimaDHBB as B " +
                "on A.KelompokBarang=B.KelompokBarang " +
                "where A.KelompokBarang=B.KelompokBarang ",
            _menuId: menuId
        },
        type: 'GET',
        datatype: 'json'
...
function InsertGridFrom() {
    ...
    return $.ajax({
        ...
        data: {
            ...
            scriptSQL:
                "Select NEWID()  as EvaluasiDHBBId,'' as NomorPenerimaan,A.NamaBarang, A.NamaSatuan, A.Spesifikasi, A.Merk, A.HargaDasar, (A.HargaDasar * (1 + (A.Overhead))) as Harga,A.KelompokBarang, A.SudahTerima, cast('" + kebunId + "' as uniqueidentifier) as KebunId " +
