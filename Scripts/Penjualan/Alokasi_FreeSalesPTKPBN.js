...
var rowNumber = 0;
var menuId = 'd7c3d0c1-7045-4b8c-a648-b9066486ab06';
...
function cekNoChop(chop) {
    ...
    return $.ajax({
        url: url,
        data: {
            scriptSQL: "select A.GradeId, B.Nama As NamaGrade, A.QtySacks, A.Gross, A.Tare, A.SatuanId, C.Nama as NamaSatuan, A.DTL_ProductSampleId, 'A6661F0F-16AA-43A0-9DAC-4B405B5BD781' as AlokasiId, '00000000-0000-0000-0000-000000000000' as BuyerId, A.BrokerId from [SPDK_KanpusEF].[dbo].[DTL_ProductSample] as A " +
...
function ViewToModel() {
    var budidaya = "Teh";
    var statusAlokasi = "Free Sales PT. KPB";
    var mdl = {
        HDR_AlokasiId: $('#HDR_AlokasiId').val(),
