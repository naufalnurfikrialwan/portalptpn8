...
var rowNumber = 0;
var menuId = '31EADECF-DC5D-4E8B-ABC5-6B3B74CF5575';
    ...
    return $.ajax({
        ...
        data: {
            ...
            scriptSQL: "INSERT INTO [SPDK_KanpusEF].[dbo].[DTL_Faktur] " +
                ...
                " join [SPDK_KanpusEF].[dbo].[HDR_PO] as B on A.HDR_POId=B.HDR_POId" +
                " where A.HDR_POId IN (" + str + ") and (A.SudahFaktur=0 or B.No_PO like '%PO%') ",
            _menuId: menuId
        },
        type: 'POST',
        datatype: 'json'
    ...
    if (headerBaru == true) {
        return {
            ...
            scriptSQL: "select DISTINCT A.HDR_POId, A.No_PO, A.Tanggal_PO, A.Pejabat from [SPDK_KanpusEF].[dbo].[HDR_PO] as A" +
                ...
                " where A.VerKaur=1 and A.BuyerId='" + $('#BuyerId').val() + "' and  (B.SudahFaktur=0 or A.No_PO like '%PO%') and A.MainBudidayaId='" + $("#MainBudidayaId").val() +
