...
var rowNumber = 0;
var menuId = '94195664-a71d-164d-6673-83cda23158d7';
var dataSource;
    ...
    function downloadInsertGridFrom() {
        ...
        return $.ajax({
            ...
            data: {
                ...
                scriptSQL: "select * from [dbo].[HDR_SC] where TahunBuku=" + $('#TahunBuku').val() + " and MainBudidayaId='3D662350-146F-48B0-A181-5A840330C451' and No_SC='" + $('#No_SC').val() + "'",
                _menuId: menuId,
                _cs: "csKPBN"
            },
            type: 'POST',
