...
function grdOnEdit(e) {
    ...
    else if (jarak > 50 && jumlahHari == 0) { kmdanmenginap = "Tdk Menginap > 50 km" }
    if (jarak < 51 && jumlahHari > 0) { kmdanmenginap = "Menginap < 50 km" }
    else if (jarak > 50 && jumlahHari > 0) { kmdanmenginap = "Menginap > 50 km" }
    else if (jarak == null && jumlahHari > 0 && jenisTujuan == "Dalam Wilayah") { kmdanmenginap = "Menginap < 50 km" }
    else if (jarak == null && jumlahHari == 0 && jenisTujuan == "Dalam Wilayah") { kmdanmenginap = "Tdk Menginap < 50 km" }
    else if (jarak == null && jumlahHari == 0 && jenisTujuan == "Luar Wilayah < 50 km") { kmdanmenginap = "Tdk Menginap < 50 km" }
    else if (jarak == null && jumlahHari > 0 && jenisTujuan == "Luar Wilayah < 50 km") { kmdanmenginap = "Menginap < 50 km" }
    else if (jarak == null && jumlahHari == 0 && jenisTujuan == "Luar Wilayah > 50 km") { kmdanmenginap = "Tdk Menginap > 50 km" }
    else if (jarak == null && jumlahHari > 0 && jenisTujuan == "Luar Wilayah > 50 km") { kmdanmenginap = "Menginap > 50 km" }
    ...
    if (jenisTujuan == "Dalam Wilayah") {
        if (tujuandlmwilayah == "Lain-Lain < 50" || tujuandlmwilayah == "Lain-Lain > 50") {
    ...
    else if (jenisTujuan == "Luar Wilayah < 50 km" || "Luar Wilayah > 50 km") {
        $(e.container).find("input[name='Tujuan']").prop('disabled', false);
