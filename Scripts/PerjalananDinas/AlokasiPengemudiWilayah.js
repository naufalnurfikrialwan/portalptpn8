...
var gridStatus;
var jumlahHari, jenisTujuan, kmdanmenginap, dapatPenginapan, jumlahMakan,tujuandlmwilayah;
...
function grdOnEdit(e) {
    ...
    if (jarak < 51 && jumlahHari == 0 && DalamWilayahKerja == 1) { kmdanmenginap = "Tdk Menginap < 50 km"; }
    else if (jarak < 51 && jumlahHari > 0 && DalamWilayahKerja == 1) { kmdanmenginap = "Menginap < 50 km"; }
    else if (jarak > 50 && jumlahHari == 0 && DalamWilayahKerja == 1) { kmdanmenginap = "Tdk Menginap > 50 km"; }
    else if (jarak > 50 && jumlahHari > 0 && DalamWilayahKerja == 1) { kmdanmenginap = "Menginap > 50 km"; }
