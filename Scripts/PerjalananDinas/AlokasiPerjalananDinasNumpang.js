...
var rowNumber = 0;
var menuId = '494A31E7-E417-4FF1-8183-FABE9358AE20';
...
function ModelToView(_NomorInputView) {
    ...
    $('#KendaraanDinas').val(_NomorInputView.KendaraanDinas);
...
function ViewToModel() {
    var statusPerjalananDinas = "Numpang";
    ...
    var mdl = {
        ...
        KendaraanDinas:  $('#KendaraanDinas').val(),
    ...
    if (headerBaru == true) {
        ...
        return {
            ...
            scriptSQL: "select DISTINCT A.HDR_PermintaanPerjalananDinasKanpusId, A.NomorPermintaan, A.TanggalPermintaan from [SPDK_KanpusEF].[dbo].[HDR_PermintaanPerjalananDinasKanpus] as A" +
                ...
                " where A.VerKaur=1 and B.SudahAlokasi=0 and A.Berangkat='"+berangkat+"' and A.Kembali='"+kembali+"' and A.jenisTujuan='"+jenisTujuan+"' and A.tujuan='"+tujuan+"'",
            _menuId: menuId
        }
        ...
        if (_NomorInputView.ListPermintaanPerjalananDinasKanpusId != "") {
            ...
            return {
                ...
                scriptSQL: "select DISTINCT A.HDR_PermintaanPerjalananDinasKanpusId, A.NomorPermintaan, A.TanggalPermintaan from [SPDK_KanpusEF].[dbo].[HDR_PermintaanPerjalananDinasKanpus] as A" +
                    " inner join [SPDK_KanpusEF].[dbo].[DTL_PermintaanPerjalananDinasKanpus] as B on A.HDR_PermintaanPerjalananDinasKanpusId=B.HDR_PermintaanPerjalananDinasKanpusId" +
                    " where A.Berangkat='" + berangkat + "' and A.Kembali='" + kembali + "' and A.jenisTujuan='" + jenisTujuan + "' and A.tujuan='" + tujuan + "'",
                _menuId: menuId
            }
        }
        else { return "" }
