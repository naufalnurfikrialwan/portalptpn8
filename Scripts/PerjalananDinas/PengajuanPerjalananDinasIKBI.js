                            ...
                            if (jenisTujuan == 'Dalam Wilayah') {
                                if (dapatBiayaPenginapan == 0) {
                                    if (kmdanmenginap == "Menginap < 50 km") {
                                        if (tujuandalamwilayah.toLowerCase().indexOf("bagian") > -1 || tujuandalamwilayah.toLowerCase().indexOf("sekretariat") > -1|| tujuandalamwilayah.toLowerCase().indexOf("satuan") > -1 || tujuandalamwilayah.toLowerCase().indexOf("wilayah") > -1) {
                                    ...
                                    if (kmdanmenginap == "Menginap < 50 km") {
                                        if (tujuandalamwilayah.toLowerCase().indexOf("bagian") > -1 || tujuandalamwilayah.toLowerCase().indexOf("sekretariat") > -1|| tujuandalamwilayah.toLowerCase().indexOf("satuan") > -1 || tujuandalamwilayah.toLowerCase().indexOf("wilayah") > -1) {
                                            ...
                                            " union select uraianbiaya,sum(" + jabatan1 + ") * 0 from [ReferensiEF].[dbo].[BPD] where StatusWilayah='Dalam Wilayah' and (" + kondisi4 + ")  group by uraianbiaya order by uraianbiaya";
                                        }
                                        else {
                                            kondisi1 = "uraianbiaya='Uang Saku < 50 km'";
                                            kondisi2 = "uraianbiaya='Uang Makan < 50 km'";
...
function ViewToModel() {
    ...
    { statusKMdanMenginap = "Menginap > 50 km" }
    else if (jarak == null && jumlahHari2 > 0 && namatujuan == "Lain-Lain < 50")
    { statusKMdanMenginap = "Menginap < 50 km" }
    else if (jarak == null && jumlahHari2 == 0 && namatujuan == "Lain-Lain < 50")
    { statusKMdanMenginap = "Tdk Menginap < 50 km" }
    else if (jarak == null && jumlahHari2 > 0 && namatujuan == "Lain-Lain > 50")
