...
function ModelToView(_NomorInputView) {
    ...
    namatujuan = _NomorInputView.TujuanDalamWilayah;
...
function ViewToModel() {
    ...
    if (jarak < 51 && jumlahHari2 == 0 && DalamWilayahKerja == 1) { statusKMdanMenginap = "Tdk Menginap < 50 km"; }
    else if (jarak < 51 && jumlahHari2 > 0 && DalamWilayahKerja == 1) { statusKMdanMenginap = "Menginap < 50 km"; }
    else if (jarak > 50 && jumlahHari2 == 0 && DalamWilayahKerja == 1) { statusKMdanMenginap = "Tdk Menginap > 50 km"; }
    else if (jarak > 50 && jumlahHari2 > 0 && DalamWilayahKerja == 1) { statusKMdanMenginap = "Menginap > 50 km"; }
    ...
    else if (jarak > 50 && jumlahHari2 == 0) { statusKMdanMenginap = "Tdk Menginap > 50 km" }
    else if (jarak > 50 && jumlahHari2 > 0) { statusKMdanMenginap = "Menginap > 50 km" }
    else if (jarak == null && jumlahHari2 > 0) { statusKMdanMenginap = "Menginap < 50 km" }
    else if (jarak == null && jumlahHari2 == 0) { statusKMdanMenginap = "Tdk Menginap < 50 km" }
    else if (jarak == null && jumlahHari2 > 0 && namatujuan == "Lain-Lain < 50") { statusKMdanMenginap = "Menginap < 50 km" }
    else if (jarak == null && jumlahHari2 == 0 && namatujuan == "Lain-Lain < 50") { statusKMdanMenginap = "Tdk Menginap < 50 km" }
    else if (jarak == null && jumlahHari2 > 0 && namatujuan == "Lain-Lain > 50") { statusKMdanMenginap = "Menginap > 50 km" }
    else if (jarak == null && jumlahHari2 == 0 && namatujuan == "Lain-Lain > 50") { statusKMdanMenginap = "Tdk Menginap > 50 km" }
    else if (jarak == null && jumlahHari2 > 0 && namatujuan == "Lain-Lain 100-200") { statusKMdanMenginap = "Menginap > 50 km" }
    else if (jarak == null && jumlahHari2 == 0 && namatujuan == "Lain-Lain 100-200") { statusKMdanMenginap = "Tdk Menginap > 50 km" }
    else if (jarak == null && jumlahHari2 == 0 && jenistujuan == "Luar Wilayah < 50 km") { statusKMdanMenginap = "Tdk Menginap < 50 km"; }
    else if (jarak == null && jumlahHari2 > 0 && jenistujuan == "Luar Wilayah < 50 km") { statusKMdanMenginap = "Menginap < 50 km"; }
    else if (jarak == null && jumlahHari2 == 0 && jenistujuan == "Luar Wilayah > 50 km") { statusKMdanMenginap = "Tdk Menginap > 50 km"; }
    else if (jarak == null && jumlahHari2 > 0 && jenistujuan == "Luar Wilayah > 50 km") { statusKMdanMenginap = "Menginap > 50 km"; }
