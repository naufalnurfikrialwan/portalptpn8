var hdr_PermintaanPerjalananDinasKanpusId, err;
var detailBaru = false;
var userName;
var menuId = '494A31E7-E417-4FF1-8183-FABE9358AE18';
...
function grdOnEdit(e) {
    ...
    if (model.isNew()) {
        model.id = model.uid;
        e.container.find("input[name=HDR_PermintaanPerjalananDinasKanpusId]").val(model.id).change();
    }
    // perubahan
    hdr_PermintaanPerjalananDinasKanpusId = model.id;
    //
