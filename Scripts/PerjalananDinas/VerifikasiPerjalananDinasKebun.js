var hdr_PermintaanPerjalananDinasKebunId, err;
var detailBaru = false;
var userName;
var menuId = '1BDD62F8-D9A0-4B5D-89B7-8CC73310E1E4';
...
function grdOnEdit(e) {
    ...
    if (model.isNew()) {
        model.id = model.uid;
        e.container.find("input[name=HDR_PermintaanPerjalananDinasKebunId]").val(model.id).change();
    }
    hdr_POId = model.id;
