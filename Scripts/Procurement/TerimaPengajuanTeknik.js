...
var rowNumber = 0;
var menuId = '88922CAD-7487-485B-99DF-2C39F98294A6';
    ...
    return $.ajax({
        ...
        data: {
            ...
            scriptSQL: "INSERT INTO [SPDK_KanpusEF].[dbo].[DTL_TerimaPermintaanBarangDariKebun] (DTL_TerimaPermintaanBarangDariKebunId, HDR_TerimaPermintaanBarangDariKebunId, DTL_PermintaanBarangDariKebunId, Qty_Disetujui, RekeningId, BarangId, HargaSatuan, Qty_RKAP, Qty_PKB, Spesifikasi, Merk, Keterangan, Satuan ) " +
                ...
                " where A.Bulan IN ('"+bulan1+"','"+bulan2+"','"+bulan3+"') and A.SudahTerima=0 and A.Bidang='TEKNIK DAN PENGOLAHAN' and A.Tahun =" + tahun,
            _menuId: menuId
        },
        type: 'POST',
        datatype: 'json'
...
function rekapHargaSatuan() {

    var grid = $('#grdDetail').data('kendoGrid');
    var newValue = 0;
    for (var i = 0; i < grid.dataItems().length; i++) {
        newValue += grid.dataItems()[i].HargaSatuan;
    }
    return newValue;
}
