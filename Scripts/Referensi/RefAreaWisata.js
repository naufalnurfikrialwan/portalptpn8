...
var gridStatus, kebunId, areaWisataId;
var menuId = 'AACA48A7-9594-4E2E-BBFB-5158B9CBB361';
...
function UploadSuccess(e) {
    ...
    var dataItem = grid.dataSource.get(areaWisataId);
    var row = grid.tbody.find("tr[data-uid='" + dataItem.uid + "']");

    dataItem.dirty = true;
    dataItem.FileFoto = filename;
    GetByteFromUpload(filename, areaWisataId).done(function (data) {
...
function grdOnEdit(e) {
    ...
    if (model.isNew()) {
        model.AreaWisataId = model.uid;
        model.KebunId = kebunId;
    }
    areaWisataId = model.AreaWisataId;
    gridStatus = 'sudah-diapa-apain';
}
