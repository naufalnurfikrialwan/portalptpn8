...
var gridStatus, IdBudidaya;
var menuId = '97f1068a-a414-4e81-ad9a-fe4863774118';
...
function sendData() {
    ...
    for (var i = 0; i < currentData.length; i++) {
        if (currentData[i].isNew()) {
            ...
            spupdated.push("EXEC UpdateBuyerBudidaya '" + currentData[i].BuyerId + "', '" + currentData[i].Nama + "', '" + currentData[i].Inisial + "','" + currentData[i].Direktur + "','" + currentData[i].Alamat + "','" + currentData[i].Telepon + "','" + currentData[i].Faksimili + "','" + currentData[i].Email + "','" + currentData[i].Portal + "','" + currentData[i].kd_pemb + "','" + currentData[i].Alamat1 + "','" + currentData[i].Negara + "','" + currentData[i].Propinsi + "','" + currentData[i].Kota + "','" + currentData[i].Alamat2 + "','" + currentData[i].NPWP + "'");
        }
    }
