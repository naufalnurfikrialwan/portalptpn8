...
var menuId = '46869591-4eac-4fba-ad3f-77a470f23d5c';
...
function UploadSuccess(e) {
    ...
    var dataItem = grid.dataSource.get(satuanId);
    var row = grid.tbody.find("tr[data-uid='" + dataItem.uid + "']");

    dataItem.dirty = true;
    dataItem.FileFoto = filename;
    GetByteFromUpload(filename, satuanId).done(function (data) {
...
function sendData() {
    ...
    for (var i = 0; i < currentData.length; i++) {
        if (currentData[i].isNew()) {
            ...
            spnew.push("EXEC InsertSatuan '" + currentData[i].SatuanId + "'00000000-0000-0000-0000-000000000000'");
    ...
    for (var i = 0; i < grid.dataSource._destroyed.length; i++) {
        ...
        spdeleted.push("EXEC DeleteSatuan '" + currentData[i].SatuanId + "'");
    }
