...
var rowNumber = 0;
var menuId = '138fdf36-ee5f-4583-935c-2cdadd7fcf5b';
var IHTBukan = 'Bukan';
...
function InsertGridFrom() {
    ...
    return $.ajax({
        ...
        data: {
            ...
            scriptSQL:  "EXEC remisehitunggaji '" + $('#KebunId').val() + "'," + $('#BulanRemise').val() + "," + $('#TahunRemise').val() + "; "+
                        "EXEC PROC_RemiseKebutuhanModalKerja '" + $('#HDR_RemiseId').val() + "','" + $('#KebunId').val() + "'," + $('#BulanRemise').val() + "," + $('#TahunRemise').val() + ",'" + IHTBukan +"','TENGAH','DIKANPUS'",
            _menuId: menuId
        },
        type: 'POST',
        datatype: 'json'
