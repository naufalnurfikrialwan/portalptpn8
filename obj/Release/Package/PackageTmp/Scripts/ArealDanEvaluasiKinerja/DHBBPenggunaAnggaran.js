...
var gridStatus;
var menuId = '95881718-61E2-4B19-B4C0-D84A96DEBE5B';
...
function InsertGridFrom() {
    ...
    return $.ajax({
        ...
        data: {
            ...
            scriptSQL: 
                       "Select NEWID()  as EvaluasiDHBBId,B.NomorPenerimaan, B.TanggalPenerimaan, A.NamaBarang, A.NamaSatuan, A.Spesifikasi, A.Merk, A.HargaDasar, (A.HargaDasar * (1 + (A.Overhead))) as Harga, A.SudahTerima " +
                       ...
                       "where B.BulanTerima=" + bulan + " and B.TahunTerima=" + tahun + " and A.SudahTerima=0 "+
                       "",
...
function grdOnEdit(e) {
    ...
    $(e.container).find("input[name='TanggalPenerimaan']").prop('disabled', true);
