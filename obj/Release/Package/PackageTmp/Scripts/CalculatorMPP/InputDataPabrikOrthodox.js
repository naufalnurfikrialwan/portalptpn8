...
var mPP_RasioPabrikOrthodoxId;
var _NomorInputView;
var model;
var headerBaru, detailBaru;
var rowNumber = 0;
var menuId = '70ce485d-1d2a-478a-8f43-0679f5f0d672';
var jumlah;
        ...
        $scope.validate = function (event) {
            ...
            if ($scope.validator.validate()) {
                simpanHeader().done(function (data) {
                    if (data) {
                        mPP_RasioPabrikOrthodoxId = $('#MPP_RasioPabrikOrthodoxId').val();
...
function ModelToView(_NomorInputView) {
    $('#MPP_RasioPabrikOrthodoxId').val(_NomorInputView.MPP_RasioPabrikOrthodoxId);
    ...
    $('#TipePabrikOrthodox').data('kendoDropDownList').value(_NomorInputView.TipePabrikOrthodox);
    $('#RatioBK').val(_NomorInputView.RatioBK);
    $('#TingkatMCOrthodox').val(_NomorInputView.TingkatMCOrthodox);
    $('#KapasitasPabrikOrthodox').val(_NomorInputView.KapasitasPabrikOrthodox);
    $('#JumlahShiftOrthodox').val(_NomorInputView.JumlahShiftOrthodox);
...
function ViewToModel() {
    var mdl = {
        ...
        TipePabrikOrthodox: $('#TipePabrikOrthodox').val(),
        RatioBK: $('#RatioBK').val(),
        TingkatMCOrthodox: $('#TingkatMCOrthodox').val(),
        KapasitasPabrikOrthodox: $('#KapasitasPabrikOrthodox').val(),
        JumlahShiftOrthodox: $('#JumlahShiftOrthodox').val(),
...
function NomorInputViewOnSelect(e) {
    if (gridStatus == 'sudah-nyoba-disimpan-tapi-model-masih-salah' ||
        ...
        mPP_RasioPabrikOrthodoxId = _NomorInputView.MPP_RasioPabrikOrthodoxId;
