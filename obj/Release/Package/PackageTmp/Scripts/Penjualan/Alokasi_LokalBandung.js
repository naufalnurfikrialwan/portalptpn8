...
var rowNumber = 0;
var menuId = 'd7c3d0c1-7045-4b8c-a648-b9066486ab05';
...
function cekNoChop(chop) {
    ...
    return $.ajax({
        url: url,
        data: {
            scriptSQL: "select A.GradeId, B.Nama As NamaGrade, A.QtySacks, A.Gross, A.Tare, A.SatuanId, C.Nama as NamaSatuan, A.DTL_ProductSampleId, '014C39B0-79AE-42AC-88F0-D69222E177FA' as AlokasiId, '00000000-0000-0000-0000-000000000000' as BuyerId, A.BrokerId from [SPDK_KanpusEF].[dbo].[DTL_ProductSample] as A " +
...
function ViewToModel() {
    var budidaya = "Teh";
    var statusAlokasi = "Lokal Bandung (PJB)";
    var mdl = {
        HDR_AlokasiId: $('#HDR_AlokasiId').val(),
