...
var rowNumber = 0;
var menuId = '39FD6CB1-5B19-49D4-873B-98EFE0F49D2F';
var kebunId;
            ...
            return $.ajax({
                ...
                data: {
                    ...
                    scriptSQL: "INSERT INTO [SPDK_KanpusEF].[dbo].[DTL_PPB] " +
                        ...
                        " inner join [ReferensiEF].[dbo].[KebunBudidaya] as B on A.MerkId=B.KebunBudidayaId" +
                        " where HDR_POId IN (" + strPO + ") and B.KebunId='" + $('#KebunId').val() + "'",
                    _menuId: menuId
                },
                type: 'POST',
                datatype: 'json'
            ...
            return $.ajax({
                ...
                data: {
                    ...
                    scriptSQL: "INSERT INTO [SPDK_KanpusEF].[dbo].[DTL_PPB] " +
                        ...
                        " from [SPDK_KanpusEF].[dbo].[DTL_Faktur] as A" +
                        " inner join [ReferensiEF].[dbo].[KebunBudidaya] as B on A.MerkId=B.KebunBudidayaId" +
                        " where HDR_FakturId IN (" + strFaktur + ")",
                    _menuId: menuId
                },
                type: 'POST',
                datatype: 'json'
