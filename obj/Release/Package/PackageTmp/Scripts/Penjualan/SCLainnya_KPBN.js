...
var rowNumber = 0;
var menuId = 'f8530859-3bf1-8a70-5715-9bc08f144685';
var dataSource;
...
function btnPilihOnClick() {
    ...
    _NomorInputView.NamaMainBudidaya = $('#NamaMainBudidaya').val();
    ModelToView(_NomorInputView);
...
function downloadInsertGridFrom() {
    ...
    return $.ajax({
        ...
        data: {
            ...
            scriptSQL: "select * from [dbo].[HDR_SC] where TahunBuku=" + $('#TahunBuku').val() + " and MainBudidayaId='" + $('#MainBudidayaId').val() + "' and No_SC='" + $('#No_SC').val() + "'",
            _menuId: menuId,
            _cs: "csKPBN"
        },
        type: 'POST',
