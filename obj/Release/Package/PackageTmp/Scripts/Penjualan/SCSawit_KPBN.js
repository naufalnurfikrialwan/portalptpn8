...
var rowNumber = 0;
var menuId = '37b163b5-8dca-6e58-8326-a182e52f98cc';
var dataSource;
...
function btnPilihOnClick() {
    ...
    _NomorInputView.NamaMainBudidaya = 'SAWIT';
    ModelToView(_NomorInputView);
...
function downloadInsertGridFrom() {
    ...
    return $.ajax({
        ...
        data: {
            ...
            scriptSQL: "select * from [dbo].[HDR_SC] where TahunBuku=" + $('#TahunBuku').val() + " and MainBudidayaId='55C355B8-E57A-48B5-A2B0-1E71B4CCF5AB' and No_SC='" + $('#No_SC').val() + "'",
            _menuId: menuId,
            _cs: "csKPBN"
        },
        type: 'POST',
