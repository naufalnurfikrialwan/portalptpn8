var hdr_FakturId, err;
    var detailBaru = false;
    var userName;
	var menuId='1C78F8A2-91A2-4839-8EED-4E3245031D6A';
...
$(window).on("unload", function () {
    ...
    function grdOnEdit(e) {
        ...
        if (model.isNew()) {
            model.id = model.uid;
            e.container.find("input[name=HDR_FakturId]").val(model.id).change();
        }
        hdr_FakturId = model.id;
