...
function grdOnEdit(e) {
    ...
    if (jarak < 51 && jumlahHari == 0)
    ...
    else if (jarak > 50 && jarak < 100 && jumlahHari == 0)
        ...
        { statusKMdanMenginap = "Tdk Menginap < 100 km" }
    else if (jarak == null && jumlahHari == 0 && jenisTujuan == "Luar Wilayah < 100 km")
        { statusKMdanMenginap = "Tdk Menginap < 100 km" }
    else if (jarak == null && jumlahHari > 0 && jenisTujuan == "Luar Wilayah < 100 km")
        { statusKMdanMenginap = "Menginap < 100 km" }
    else if (jarak == null && jumlahHari == 0 && jenisTujuan == "Luar Wilayah > 100 km")
    ...
    else if (jenisTujuan == "Luar Wilayah > 100 km" || jenisTujuan == "Luar Wilayah < 100 km") {
        $(e.container).find("input[name='Tujuan']").prop('disabled', false);
