...
var rowNumber = 0;
var menuId = '7d4d949c-f6d4-4ea1-b796-412e14d02341';
                            ...
                            if (jenisTujuan == 'Dalam Wilayah') {
                                if (dapatBiayaPenginapan == 0) {
                                    if (kmdanmenginap == "Menginap Di Dalam Wilayah Kerja < 50 km") {
                                        ...
                                        else if (tujuandalamwilayah.toLowerCase().indexOf("divisi") > -1) {
                                            kondisi1 = "uraianbiaya='Uang Saku < 100 km'";
                                            kondisi2 = "uraianbiaya='Makan Pagi' or uraianbiaya='Makan Siang' or uraianbiaya='Makan Malam'";
                                            kondisi3 = "uraianbiaya='Biaya Cucian'";
                                            cSQL = "select uraianbiaya,sum(" + jabatan1 + ") * (" + jumlahHari + "+1) from [ReferensiEF].[dbo].[BPD] where StatusWilayah=' + Dalam Wilayah + ' and (" + kondisi1 + ") group by uraianbiaya" +
                                        ...
                                        if (tujuandalamwilayah.toLowerCase().indexOf("divisi") > -1) {
                                            kondisi1 = "uraianbiaya='Uang Saku < 100 km'"
                                            kondisi2 = "uraianbiaya='Makan Pagi' or uraianbiaya='Makan Malam' or uraianbiaya='Makan Siang'";
                            ...
                            HitungTaripBPD(cSQL).done(function (data) {
                                if (jenisTujuan == 'Luar Wilayah < 100 km' || jenisTujuan == 'Luar Wilayah > 100 km') {
                                    ...
                                    if (data.length == 6) {
                                        ...
                                        else if (jenisTujuan == "Dalam Wilayah Kerja PTPN VIII") {
                                            dataItem.dirty = true;
...
function ViewToModel() {
    ...
    if (tujuan == "Jakarta" && (jumlahHari2 == 0 || jumlahHari2 > 0))
...
function sendData() {
    ...
    for (var i = 0; i < currentData.length; i++) {
        if (currentData[i].isNew()) {
            ...
            spupdated.push("Update [SPDK_KanpusEF].[dbo].[DTL_PermintaanPerjalananDinasIKBI] set JumlahBpd=UangSaku+UangMakan+UangCucian+UangTransport+UangLain+UangPenginapan");
        }
    }
...
function filterPengemudi() {
    ...
    return {
        ...
        scriptSQL: "select distinct NAMA, REG from [SPDK_KanpusEF].[dbo].[Ref_Dik]" +
            " where (NAMA_JAB like '%pengemudi%' or NAMA_JAB like '%supir%' or NAMA_JAB like '%sopir%') and KD_KBN = '" + $('#Kd_Kbn').val() + "' and MBT= 'K' and Year(Tanggal) = '" + tahunpermintaan + "'" +
            " union select distinct NAMA, REG from [SPDK_KanpusEF].[dbo].[Ref_DikKLM]" +
            " where (NAMA_JAB like '%pengemudi%' or NAMA_JAB like '%supir%' or NAMA_JAB like '%sopir%') and KD_KBN = '" + $('#Kd_Kbn').val() + "' and Year(Tanggal) = " + tahunpermintaan,
        _menuId: menuId
    }
}
