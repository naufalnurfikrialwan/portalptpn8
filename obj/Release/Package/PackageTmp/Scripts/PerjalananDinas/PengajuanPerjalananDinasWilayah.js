...
var rowNumber = 0;
var menuId = '7d4d949c-f6d4-4ea1-b796-412e14d02342';
...
var lokasiKerjaTujuanId, namatujuan, DalamWilayahKerja;
                ...
                if (input.attr("name") == "NIK" || input.attr("name") == "Nama" || input.attr("name") == "Golongan" || input.attr("name") == "Jabatan") {
                    cekNIK($('#NIK').val()).done(function (data) {
                        if (data.length > 0) {
                            ...
                            if (jenisTujuan == "Dalam Wilayah") { var kmdanmenginap = statusKMdanMenginap; }
                            ...
                            else if (jenisTujuan == "Jakarta PP") { var kmdanmenginap = "Jakarta"; }
                            else if (jenisTujuan == "Jakarta Nginap") { var kmdanmenginap = "Jakarta"; }
                            ...
                            else if (jabatan.toLowerCase().indexOf("general") > -1) { jabatan1 = "PJP" }
                            ...
                            else if (jabatan.toLowerCase().indexOf("asisten manager") > -1) { jabatan1 = "Kaur" }
                            ...
                            if (golongan1 == "IA" || golongan1 == "IB" || golongan1 == "IC" || golongan1 == "ID") {
                                ...
                                if (jabatan.toLowerCase().indexOf("staf") > -1 || jabatan.toLowerCase().indexOf("asisten afdeling") > -1 || jabatan.toLowerCase().indexOf("asisten pengolahan") > -1 || jabatan.toLowerCase().indexOf("asisten administrasi") > -1 || jabatan.toLowerCase().indexOf("asisten teknik") > -1) { jabatan1 = "Gol_III" }
                            }
                            ...
                            if (jenisTujuan == "Dalam Wilayah") {
                                if (dapatBiayaPenginapan == 0) {
                                    if (kmdanmenginap == "Menginap Di Dalam Wilayah Kerja < 50 km") {
                                        ...
                                        if (tujuandalamwilayah.toLowerCase().indexOf("divisi") > -1 || tujuandalamwilayah.toLowerCase().indexOf("sekretaris") > -1) {
                                            kondisi1 = "uraianbiaya='Uang Saku < 100 km'";
                                            kondisi2 = "uraianbiaya='Makan Pagi' or uraianbiaya='Makan Siang' or uraianbiaya='Makan Malam'";
                                            kondisi3 = "uraianbiaya='Biaya Cucian'";
                                        ...
                                        if (tujuandalamwilayah.toLowerCase().indexOf("divisi") > -1 || tujuandalamwilayah.toLowerCase().indexOf("sekretaris") > -1) {
                                            ...
                                            kondisi1 = "uraianbiaya='Uang Saku < 100 km'"
                                            kondisi2 = "uraianbiaya='Makan Pagi' or uraianbiaya='Makan Malam' or uraianbiaya='Makan Malam'";
                                            cSQL = "select uraianbiaya,sum(" + jabatan1 + ") from [ReferensiEF].[dbo].[BPD] where StatusWilayah='Dalam Wilayah' and (" + kondisi1 + ") group by uraianbiaya" +
                                                " union select uraianbiaya,sum(" + jabatan1 + ") from [ReferensiEF].[dbo].[BPD] where StatusWilayah='Dalam Wilayah' and (" + kondisi2 + ") group by uraianbiaya order by uraianbiaya";
                                        }
                                    ...
                                    if (kmdanmenginap == "Menginap < 100 km") {
                                        if (tujuandalamwilayah.toLowerCase().indexOf("divisi") > -1 || tujuandalamwilayah.toLowerCase().indexOf("sekretaris") > -1) {
                                            ...
                                            cSQL = "select uraianbiaya,sum(" + jabatan1 + ") * (" + jumlahHari + "+1) from [ReferensiEF].[dbo].[BPD] where StatusWilayah='Dalam Wilayah' and (" + kondisi1 + ") group by uraianbiaya" +
                                                ...
                                                " union select uraianbiaya,sum(" + jabatan1 + ") * " + jumlahHari + " from [ReferensiEF].[dbo].[BPD] where StatusWilayah='Dalam Wilayah' and (" + kondisi4 + ")  group by uraianbiaya order by uraianbiaya";
                                        }
                                ...
                                if (kendaraanDinas == 0) {
                                    ...
                                    else if (kmdanmenginap == "Tdk Menginap < 100 km" || kmdanmenginap == "Tdk Menginap 100-200 km" || kmdanmenginap == "Tdk Menginap > 100 km") {
                                        kondisi1 = "uraianbiaya='Uang Saku'"
                                        kondisi2 = "uraianbiaya='Uang Makan'"
                                ...
                                if (kendaraanDinas == 0) {
                                    if (kmdanmenginap == "Menginap < 100 km" || kmdanmenginap == "Menginap 100-200 km" || kmdanmenginap == "Menginap > 200 km") {
                                        if (dapatBiayaPenginapan == 0) {
                                            ...
                                            kondisi3 = "uraianbiaya='Biaya Cucian'";
                                            kondisi4 = "uraianbiaya='Biaya Transport Lokal'";
                                            cSQL = "select uraianbiaya,0 from [ReferensiEF].[dbo].[BPD] where StatusWilayah='Luar Wilayah' and (" + kondisi1 + ") group by uraianbiaya" +
                                                " union select uraianbiaya,sum(" + jabatan1 + ") * (" + jumlahHari + "+1) from [ReferensiEF].[dbo].[BPD] where StatusWilayah='Luar Wilayah' and (" + kondisi2 + ") group by uraianbiaya" +
                                                " union select uraianbiaya,sum(" + jabatan1 + ") * " + jumlahHari + " from [ReferensiEF].[dbo].[BPD] where StatusWilayah='Luar Wilayah' and (" + kondisi3 + ")  group by uraianbiaya" +
                                                " union select uraianbiaya,sum(" + jabatan1 + ") * (" + jumlahHari + "+1) from [ReferensiEF].[dbo].[BPD] where StatusWilayah='Luar Wilayah' and (" + kondisi4 + ")  group by uraianbiaya order by uraianbiaya";
                                        }
                                    ...
                                    else if (kmdanmenginap == "Tdk Menginap < 100 km" || kmdanmenginap == "Tdk Menginap 100-200 km" || kmdanmenginap == "Tdk Menginap > 200 km") {
                                        kondisi1 = "uraianbiaya='Uang Saku'"
                                        kondisi2 = "uraianbiaya='Uang Makan'"
                                        kondisi3 = "uraianbiaya='Biaya Transport Lokal'";
                                        cSQL = "select uraianbiaya,0 from [ReferensiEF].[dbo].[BPD] where StatusWilayah='Luar Wilayah' and (" + kondisi1 + ") group by uraianbiaya" +
                            ...
                            HitungTaripBPD(cSQL).done(function (data) {
                                if (jenisTujuan == 'Luar Wilayah > 100 km' || jenisTujuan == 'Luar Wilayah < 100 km') {
                                    ...
                                    if (data.length == 6) {
                                        ...
                                        if ((tujuandalamwilayah.toLowerCase().indexOf("divisi") > -1 || tujuandalamwilayah.toLowerCase().indexOf("sekretaris") > -1) && dapatBiayaPenginapan == 0) {
                                            dataItem.dirty = true;
                                            dataItem["UangCucian"] = parseFloat(data[0][1]);
                                            //dataItem["UangPenginapan"] = parseFloat(data[1][1]);
    ...
    return $.ajax({
        ...
        data: {
            scriptSQL: "select top 1 A.Nama, A.Gol, A.MK, A.Nama_Jab from [SPDK_KanpusEF].[dbo].[Ref_Dik] as A " +
                " join [ReferensiEF].[dbo].[Wilayah] as B on A.kd_kbn=B.kd_kbn" +
                " where B.WilayahId='" + kebunId + "' and A.reg='" + dataItem.NIK + "' and Year(A.Tanggal)=" + tahunPermintaan + " and Month(A.Tanggal)=" + bulanPermintaan + " and (A.Nama_Jab !='Pengemudi' or A.Nama_Jab !='Supir' or A.Nama_Jab !='Sopir') " +
                " union select top 1 A.Nama, '' as Gol, '' as MK, ''  as Nama_Jab from [SPDK_KanpusEF].[dbo].[Ref_DikKLM] as A " +
                " join [ReferensiEF].[dbo].[Wilayah] as B on A.kd_kbn=B.kd_kbn" +
                " where (A.Nama_Jab !='Pengemudi' or A.Nama_Jab !='Supir' or A.Nama_Jab !='Sopir') and B.WilayahId='" + kebunId + "' and A.reg='" + dataItem.NIK + "' and Year(A.Tanggal)=" + tahunPermintaan + " and Month(A.Tanggal)=" + bulanPermintaan,
            _menuId: menuId
        },
        type: 'GET',
        datatype: 'json'
...
function ViewToModel() {
    ...
    var jumlahHari2 = (((((pisahTanggalAkhir - pisahTanggalAwal) / 1000) / 60) / 60) / 24);

    jenistujuan2 = jenistujuan;
    if (jenistujuan == "Jakarta" && jumlahHari2 == 0) { jenistujuan2 = "Jakarta PP" }
    else if (jenistujuan == "Jakarta" && jumlahHari2 > 0) { jenistujuan2 = "Jakarta Nginap" }

    if (jarak < 51 && jumlahHari2 == 0 && DalamWilayahKerja == 1) { statusKMdanMenginap = "Tdk Menginap Di Dalam Wilayah Kerja < 50 km"; }
    else if (jarak < 51 && jumlahHari2 > 0 && DalamWilayahKerja == 1) { statusKMdanMenginap = "Menginap Di Dalam Wilayah Kerja < 50 km"; }
    else if (jarak > 50 && jumlahHari2 == 0 && DalamWilayahKerja == 1) { statusKMdanMenginap = "Tdk Menginap Di Dalam Wilayah Kerja > 50 km"; }
    else if (jarak > 50 && jumlahHari2 > 0 && DalamWilayahKerja == 1) { statusKMdanMenginap = "Menginap Di Dalam Wilayah Kerja > 50 km"; }
    else if (jarak < 51 && jumlahHari2 == 0) { statusKMdanMenginap = "Tdk Menginap < 50 km"; }
    else if (jarak < 51 && jumlahHari2 > 0) { statusKMdanMenginap = "Menginap < 50 km"; }
    else if (jarak > 50 && jarak < 100 && jumlahHari2 == 0) { statusKMdanMenginap = "Tdk Menginap < 100 km"; }
    else if (jarak < 100 && jumlahHari2 == 0) { statusKMdanMenginap = "Tdk Menginap < 100 km" }
    else if (jarak > 100 && jarak < 200 && jumlahHari2 == 0) { statusKMdanMenginap = "Tdk Menginap 100-200 km" }
    else if (jarak > 200 && jumlahHari2 == 0) { statusKMdanMenginap = "Tdk Menginap > 200 km" }
    else if (jarak < 100 && jumlahHari2 > 0) { statusKMdanMenginap = "Menginap < 100 km" }
    else if (jarak > 100 && jarak < 200 && jumlahHari2 > 0) { statusKMdanMenginap = "Menginap 100-200 km" }
    else if (jarak > 200 && jumlahHari2 > 0) { statusKMdanMenginap = "Menginap > 200 km" }
    else if (jarak == null && jumlahHari2 > 0) { statusKMdanMenginap = "Menginap < 100 km" }
    else if (jarak == null && jumlahHari2 == 0) { statusKMdanMenginap = "Tdk Menginap < 100 km" }
    else if (jarak == null && jumlahHari2 > 0 && namatujuan == "Lain-Lain < 100") { statusKMdanMenginap = "Menginap < 100 km" }
    else if (jarak == null && jumlahHari2 == 0 && namatujuan == "Lain-Lain < 100") { statusKMdanMenginap = "Tdk Menginap < 100 km" }
    else if (jarak == null && jumlahHari2 > 0 && namatujuan == "Lain-Lain > 200") { statusKMdanMenginap = "Menginap > 200 km" }
    else if (jarak == null && jumlahHari2 == 0 && namatujuan == "Lain-Lain > 200") { statusKMdanMenginap = "Tdk Menginap > 200 km" }
    else if (jarak == null && jumlahHari2 > 0 && namatujuan == "Lain-Lain 100-200") { statusKMdanMenginap = "Menginap 100-200 km" }
    else if (jarak == null && jumlahHari2 == 0 && namatujuan == "Lain-Lain 100-200") { statusKMdanMenginap = "Tdk Menginap 100-200 km" }
    else if (jarak == null && jumlahHari2 == 0 && jenistujuan == "Luar Wilayah < 100 km") { statusKMdanMenginap = "Tdk Menginap < 100 km"; }
    else if (jarak == null && jumlahHari2 > 0 && jenistujuan == "Luar Wilayah < 100 km") { statusKMdanMenginap = "Menginap < 100 km"; }
    else if (jarak == null && jumlahHari2 == 0 && jenistujuan == "Luar Wilayah > 100 km") { statusKMdanMenginap = "Tdk Menginap > 100 km"; }
    else if (jarak == null && jumlahHari2 > 0 && jenistujuan == "Luar Wilayah > 100 km") { statusKMdanMenginap = "Menginap > 100 km"; }

    if (tujuan == "Jakarta" && (jumlahHari2 == 0 || jumlahHari2 > 0)) { statusKMdanMenginap = "Jakarta" }
...
function filterNomorInput(e) {
    ...
    return { _model: mdl, _menuId: '7d4d949c-f6d4-4ea1-b796-412e14d02342' };
}
...
function filterPengemudi() {
    ...
    return {
        ...
        scriptSQL: "select distinct NAMA, REG from [SPDK_KanpusEF].[dbo].[Ref_Dik]" +
            " where (NAMA_JAB like '%pengemudi%' or NAMA_JAB like '%sopir%' or NAMA_JAB like '%supir%') and KD_KBN = '" + $('#Kd_Kbn').val() + "' and Year(Tanggal) = '" + tahunpermintaan + "'" +
