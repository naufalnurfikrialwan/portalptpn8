...
var rowNumber = 0;
var menuId = '7321715B-E77A-4A57-A387-4ACAB62DBE87';
...
function filterdetailRead(e) {
    ...
    //return {
    //    _menuId: menuId,
    //    _filter: ['TahunBuku', $('#TahunBuku').val(), 'month(tanggal_memodinas)', nBulan+1]
    //};

    return {
        strClassView: "Ptpn8.Models.MemoOnline.ViewKirim_MemoDinas",
        scriptSQL: "SELECT [Kirim_MemoDinasId], [UnitId],[Nomor_MemoDinas],[Tanggal_MemoDinas],[Perihal_MemoDinas],[TujuanId_MemoDinas] " +
        ",[CCTujuanId_MemoDinas],[Lampiran_MemoDinas],[TanggalDikirim_MemoDinas],[StatusMemoDinas] " +
        ",[Isi_MemoDinasFinal],[SifatSurat_MemoDinas],[StatusDistribusi] " +
        "FROM [SPDK_KanpusEF].[dbo].[eOffice_Kirim_MemoDinas] " +
        "where month(tanggal_memodinas) = " + nBulan.toString() + " and year(tanggal_memodinas) = " + $('#TahunBuku').val().toString() + " and UnitId= '" + $('#UnitId').val() + "' " +
        "order by Tanggal_MemoDinas desc",
        _menuId: menuId
    };
}
