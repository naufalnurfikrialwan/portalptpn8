var hdr_PermintaanBarangDariKebunId;
var detailBaru = false;
var userName;
var menuId = '8309175B-F735-4FD7-8732-ECEA2F152542';
...
function grdOnEdit(e) {
    ...
    if (model.isNew()) {
        model.id = model.uid;
        e.container.find("input[name=HDR_PermintaanBarangDariKebunId]").val(model.id).change();
    }
