var hdr_TerimaPermintaanBarangDariKebunId;
var detailBaru = false;
var userName;
var menuId = '209B9929-2A7D-4E5C-860E-7A1A79E55E5E';
...
function grdOnEdit(e) {
    ...
    if (model.isNew()) {
        model.id = model.uid;
        e.container.find("input[name=HDR_TerimaPermintaanBarangDariKebunId]").val(model.id).change();
    }
    hdr_TerimaPermintaanBarangDariKebunId = model.id;
