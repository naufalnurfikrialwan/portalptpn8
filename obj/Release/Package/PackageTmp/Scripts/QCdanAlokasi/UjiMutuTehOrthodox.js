...
var rowNumber = 0;
var menuId = 'ea16cfd5-c1dd-49f7-a799-3ae60654c4a1';
    ...
    if (headerBaru == true) {
        return {
            ...
            scriptSQL: "select DISTINCT A.HDR_ProductSampleId, A.No_ProductSample from [SPDK_KanpusEF].[dbo].[HDR_ProductSample] as A" +
                ...
                " where A.TahunBuku=" + $('#TahunBuku').val() + "and  B.SudahUji=0 and B.SubBudidayaId = '35614CD9-071A-4624-BEFF-8A4A24E63595'",
            _menuId: menuId
        }
    }
    else {
        return {
            ...
            scriptSQL: "select DISTINCT A.HDR_ProductSampleId, A.No_ProductSample from [SPDK_KanpusEF].[dbo].[HDR_ProductSample] as A" +
                " inner join [SPDK_KanpusEF].[dbo].[DTL_ProductSample] as B on A.HDR_ProductSampleId=B.HDR_ProductSampleId" +
                " where A.HDR_ProductSampleId in (" + listId + ") and B.SubBudidayaId = '35614CD9-071A-4624-BEFF-8A4A24E63595' and A.TahunBuku=" + $('#TahunBuku').val(),
            _menuId: menuId
        }
    }
}
