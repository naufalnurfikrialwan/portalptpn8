    ...
    var gridStatus;
    //var IdBudidaya = '3D662350-146F-48B0-A181-5A840330C451';
    var menuId = 'f0e2fd1a-455f-4457-b4cc-a8a12aed7e2c';
...
$(window).on("unload", function () {
    ...
    function UploadSuccess(e) {
        ...
        var dataItem = grid.dataSource.get(vesselId);
        var row = grid.tbody.find("tr[data-uid='" + dataItem.uid + "']");

        dataItem.dirty = true;
        dataItem.FileFoto = filename;
        GetByteFromUpload(filename, vesselId).done(function (data) {
    ...
    function sendData() {
        ...
        for (var i = 0; i < currentData.length; i++) {
            if (currentData[i].isNew()) {
                ...
                spnew.push("EXEC InsertVessel '" + currentData[i].VesselId + "'00000000-0000-0000-0000-000000000000'");
        ...
        for (var i = 0; i < grid.dataSource._destroyed.length; i++) {
            ...
            spdeleted.push("EXEC DeleteVessel '" + currentData[i].VesselId +"'");
        }
