...
var userName;
var menuId = 'befc954b-e57a-442a-bd6d-4fcb58e89948';
...
$(document).ready(function () {
    var h1 = parseInt($(".content-header").css("height")) + 10;
    var h2 = parseInt($(".hdr").css("height"));
    var h3 = parseInt($(".k-grid-toolbar").css("height")) + 10;
...
function grdOnEdit(e) {
    ...
    if (model.isNew()) {
        model.id = model.uid;
        e.container.find("input[name=HDR_RemiseId]").val(model.id).change();
    }
    hdr_PermintaanBarangDariKebunId = model.id;
