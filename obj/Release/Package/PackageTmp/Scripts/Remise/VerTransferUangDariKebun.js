var hdr_TransferDanaDariKebunId;
var detailBaru = false;
var userName;
var menuId = '455f69e8-aee2-4632-982a-d8bc6779244c';
...
function grdOnEdit(e) {
    ...
    if (model.isNew()) {
        model.id = model.uid;
        e.container.find("input[name=HDR_TransferDanaDariKebunId]").val(model.id).change();
    }
    hdr_TransferDanaDariKebunId = model.id;
