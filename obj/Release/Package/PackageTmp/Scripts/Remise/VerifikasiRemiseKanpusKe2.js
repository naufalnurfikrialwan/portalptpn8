...
var rowNumber = 0;
var menuId = '80b82068-8f12-4984-94c3-21d2b21247e3';
var IHTBukan = 'Bukan';
    ...
    return $.ajax({
        ...
        data: {
            ...
            scriptSQL:  "EXEC remisehitunggaji '" + $('#KebunId').val() + "'," + $('#BulanRemise').val() + "," + $('#TahunRemise').val() + "; "+
                "EXEC PROC_VerifikasiRemiseKebutuhanModalKerja '" + $('#HDR_RemiseId').val() + "','" + $('#KebunId').val() + "'," + $('#BulanRemise').val() + "," + $('#TahunRemise').val() + ",'" + IHTBukan + "','TENGAH','DIKANPUS','" + bagianId +"'",
            _menuId: menuId
        },
        type: 'POST',
        datatype: 'json'
