...
var rowNumber = 0;
var menuId = '2e1944fc-404a-4ddb-ba22-81b5871fa045';
...
function grdOnEdit(e) {
    ...
    if (model.isNew()) {
        model.Ref_DikKLMId = model.uid;
    }
    ref_dikKLMId = model.Ref_DikKLMId;
    gridStatus = 'sudah-diapa-apain';
}
...
function filterdetailRead() {
    ...
    return {
        strClassView: "Ptpn8.UploadDataHarian.Models.ref_dikklm",
        scriptSQL: "select * from [spdk_kanpusef].dbo.ref_dikklm where kd_kbn ='"+unit+"' and year(tanggal)="+nTahun+" and month(tanggal)='"+nBulan+"'",
        _menuId: menuId
    };
}
