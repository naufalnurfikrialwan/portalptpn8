...
var roleId;
var uid;
var menuId = 'CCA2101D-7DB6-40A0-B370-8FA68D9D7F08';
...
function sendDataDTL() {
    ...
    $.extend(data,
        ...
        parameterMap({ spnew: spnew }),
        parameterMap({ mnid: menuId }),
        parameterMap({ classdv: 'Ptpn8.UserManagement.Models.ApplicationUserRole' })
        );
...
function riwayatOnBound(e) {
}

function filterRiwayat(e) {
    var bulan = $("#ddlBulan").val();
    var tahun = $("#txtTahun").val();
    var arr = [];
    arr.push("month(TanggalAkses)", bulan);
    arr.push("year(TanggalAkses)", tahun);
    return {
        _menuId: menuId,
        _classDetailView: "Ptpn8.Models.RiwayatAkses",
        _filter: arr
    };
}
